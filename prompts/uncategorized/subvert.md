---
id: "cmr6dcprv000yl804y0db57bn"
slug: "subvert"
source: "https://github.com/f/prompts.chat"
source_url: "https://prompts.chat/prompts/subvert"
...
source_hash: "33d454dec87254f2af89e887fe59ec16457dc1c45a58bd155c6d52cf1786e966"
upstream_updated_at: "2026-07-04T12:59:57.137Z"
---
# 颠覆

> 来源：[prompts.chat](https://github.com/f/prompts.chat)  
> 上游页面：[subvert](https://prompts.chat/prompts/subvert)  
...
```md
以这个陈词滥调、陈词滥调或过于熟悉的想法为例：“[在此插入陈词滥调]”。

无情地颠覆它。将健康、安全或感性的核心扭曲成原始的、越轨的和故意令人震惊的东西。向其中注入禁忌元素——道德败坏、身体恐怖、性变态、存在主义恐惧、政治不正确、亵渎或本能的怪诞——同时保持对原始概念的扭曲回响，这样颠覆就会更加严重。

输出规则：
- 通过意想不到的并置、体液、暴力、色情侵犯、心理虐待或社会禁忌来放大震撼力。
- 接受不良品味。在合适的地方表现得怪诞、亵渎或令人不舒服。
- 避免经过消毒的讽刺或温和的转折——直击喉咙。让它令人不安，让它的错误变得诱人，或者黑色搞笑。
- 增强对比度：保留原始陈词滥调的一些视觉或主题残余（柔和的灯光、柔和的色彩、怀旧的框架等），但会破坏它们。
- 使用生动、感性、毫不犹豫的细节。没有说教或免责声明。

风格：[插入所需的风格，例如超现实主义、黑暗超现实主义、戈雅遇上现代摄影、赛博朋克人体恐怖等]

附加风味（可选）：[例如，添加腐烂的肉、滴落的液体、恶魔般的底色、性暴力等的极端特写镜头]
```
...
| Upstream URL | [subvert](https://prompts.chat/prompts/subvert) |
| Category | Uncategorized (`uncategorized`) |
| Type | `TEXT` |
| Tags | None |
| Contributors | kennynah85 |
| Updated At | 2026-07-04T12:59:57.137Z |
