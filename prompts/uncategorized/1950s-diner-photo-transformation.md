...
```md
{
  ...
  “详细信息”：{
    ...
    "location": "经典的美式餐厅内饰。可见元素包括闪亮的镀铬柜台、红色乙烯基凳子、棋盘地板，背景中可能还有自动点唱机或老式冷饮机。明亮、诱人的灯光。",
    "lighting": "明亮、均匀且略微漫射的白炽灯照明，典型的熙熙攘攘的餐厅。一切都清晰可见，营造出欢快、诱人的光芒。",
    "camera_angle": "中特写，从胸部以上捕捉拍摄对象，有足够的柜台和背景来建立餐厅的背景。拍摄对象稍微看向镜头，表情温暖。（1:1构图）。",
    "emotion": "快乐、轻松、友好、无忧无虑。",
    "costume": "经典的 1950 年代服装：对于顾客来说，颜色鲜艳（例如，淡粉色或浅蓝色）的莱特曼夹克或贵宾犬裙搭配合身的毛衣。对于女服务员来说，清爽的制服（例如，浅蓝色连衣裙，白色围裙，纸帽，如果适用于车普造型，则穿溜冰鞋）。头发采用经典的 50 年代蓬松或马尾辫造型。",
    "color_palette": "充满活力和欢快的原色（红色、蓝色、黄色）与柔和的粉彩（粉色、薄荷绿、淡蓝色）和闪亮的铬银混合。强烈、干净的线条定义了物体。一切看起来新鲜而诱人。",
    "atmosphere": "乐观、怀旧、活泼、极其友好。点唱机的背景嗡嗡声充满了青春的纯真和乐趣。",
    "subject_expression": "宽阔、真诚的微笑，明亮、闪闪发光的眼睛。轻微倾斜头部，传达友好和开放。",
    "subject_action": "一只手拿着一个高高的磨砂奶昔杯，上面有一根条纹吸管，也许正在喝中。另一只手随意地放在镀铬柜台上或轻轻地做着手势。肢体语言是轻松和快乐的。",
    "environmental_elements": "一杯完美的鲜奶油奶昔加樱桃。餐厅霓虹灯标志（如果有的话）或镀铬表面上明亮的灯光的反射。柜台上的经典餐厅菜单或餐巾纸分配器。也许远处的自动点唱机上有淡淡的“Wurlitzer”标志。”
  }
}
```
