...
用于让 AI 围绕「日本」执行通用 AI 任务执行任务。它会保留原始角色、任务目标、约束条件和输出要求，适合复制给图像生成模型，控制主体、构图、风格和画面细节。
...
```md
{
  "prompt": "你将使用所提供照片中的人物作为主要拍摄对象进行图像编辑。面部必须保持清晰且不变。将拍摄对象转变为沉思的**禅僧/园丁**，在黎明时分在原始的日本禅宗花园中精心绘制图案。强调极简主义美学、柔和的自然光、宁静的色彩以及深刻的平和与正念感。",
  “详细信息”：{
    "year": "Timeless (Traditional Japanese Aesthetics)",
    "genre": "Zen / Contemplative / Minimalist / Cultural",
    "location": "一个维护完美的日本禅宗岩石花园 (Karesansui)。地面是细小的白色砾石，在精心放置的风化岩石周围耙成精确的同心图案。背景中可以看到长满青苔的石灯笼或一棵经过精心修剪的盆景树。微妙的竹栅栏包围了空间。",
    "lighting": "黎明或温和的阴天的柔和、漫射的光线。光线均匀而柔和，创造出微妙的阴影，定义倾斜的图案而不刺耳。整个场景弥漫着凉爽、宁静的品质。",
    "camera_angle": "中景到全身，位置稍低，以捕捉拍摄对象与地面和广阔的倾斜花园的互动。构图干净、平衡，遵循极简主义原则。（1:1构图）。",
    "emotion": "Serene, focused, mindful, and peaceful. A deep sense of inner calm.",
    "costume": "简单、传统的日本服装：朴素、宽松的和服或柔和、自然色调的长袍（例如炭灰色、深靛蓝、土色米色）。头发整齐地定型或剃光（如果适合僧侣的话）。干净、朴素的美感。",
    "color_palette": "以宁静、柔和的自然色彩为主：砾石的纯白色、岩石和木材的灰色和土棕色、苔藓和树叶的深绿色。强调色的使用非常微妙、克制。整体调色板和谐而平静。",
    "atmosphere": "极其平和、冥想、安静、和谐。空气清新而宁静，令人内省。强烈的秩序感和宁静感。",
    "subject_expression": "眼睛低垂或轻轻地专注于耙动任务，真实的脸上表情平静、安详。嘴唇轻轻闭上，传达出高度的专注和内心的平静。",
    "subject_action": "双手握着木耙，在白色的砾石上一丝不苟地描绘出完美、流畅的图案。他们的姿势优雅而从容地弯腰，强调了任务的仪式性。动作缓慢而有目的。",
    "environmental_elements": "白色砾石中完美定义的流动图案。风化岩石的纹理。苔藓或耙子上可能会看到细小的露珠。远处的竹篱笆为宁静的空间提供了微妙、自然的边界。"
  }
```
