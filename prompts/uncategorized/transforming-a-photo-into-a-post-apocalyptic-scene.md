...
用于让 AI 围绕「将照片转变为后世界末日场景」执行通用 AI 任务执行任务。它会保留原始角色、任务目标、约束条件和输出要求，适合复制给图像生成模型，控制主体、构图、风格和画面细节。
...
```md
{
  "prompt": "你将使用所提供照片中的人物作为主要拍摄对象进行图像编辑。脸部必须保持清晰且不变。将拍摄对象转变为冷酷的**荒地拾荒者/幸存者**，在荒凉的后世界末日景观中警惕地站在风吹的沙丘上。强调风化、打补丁的衣服、临时装备、坚韧的纹理和凄凉的生存主义者气氛。”,
  “详细信息”：{
    "year": "未定义的后世界末日未来（例如，'崩溃之后'）",
    "genre": "后世界末日/反乌托邦/生存",
    "location": "广阔、荒凉的沙漠或贫瘠的荒地。地面是龟裂的土地、风吹的沙子和散落的碎片（例如生锈的汽车零件、破碎的标志）。头顶上隐约可见一片朦胧、被污染的天空，也许远处的、被毁坏的城市天际线在地平线上几乎看不见。",
    "lighting": "刺眼、柔和、不饱和的阳光，透过尘土飞扬、烟雾缭绕的气氛。强烈的定向阴影，强调环境和拍摄对象装备的粗糙纹理。整体色调坚韧不拔，有些压抑。",
    "camera_angle": "中景到全身，位置稍低，使主体在荒凉的风景中显得令人畏惧。地平线较低，强调广阔、空旷的天空。（1:1构图）。",
    "emotion": "警惕、疲倦、有弹性、坚定。",
    "costume": "由重新利用的材料制成的分层、拼凑而成的衣服：撕破的牛仔布、破旧的皮革、破烂的帆布。实用的、实用的装备，如重型靴子、无指手套、头巾或临时面罩。绑在身上的一系列可见的捡来的物品（例如袋子、工具、水壶）。",
    "color_palette": "以不饱和的大地色调为主：尘土飞扬的棕色、褪色的绿色、柔和的灰色和生锈的橙色。重新利用的织物碎片准时出现褪色的颜色。天空是褪色的淡黄色或病态的绿色。",
    "atmosphere": "荒凉、严酷、危险和孤独。空气中弥漫着灰尘和死亡世界的寂静。一种在压倒性的困难中不断求生的感觉。",
    "subject_expression": "冷酷、专注的目光，扫视地平线以寻找威胁或资源。嘴巴紧绷、坚定。头发被风吹过，布满灰尘。",
    "subject_action": "保持警惕，可能将临时武器（例如，锋利的管子、十字弓或坚固的棍棒）放在肩上或防御性地持有。他们的立场是一种准备和谨慎的态度。",
    "environmental_elements": "细小的灰尘或沙粒明显地在对象周围的风中飘扬。远处的树木或建筑物的骨骼残骸。也许是一只在高空盘旋的食腐鸟。地面显示出裂缝和干燥的植被。"
  }
}
```
