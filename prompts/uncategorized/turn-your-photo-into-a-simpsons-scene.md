---
id: "cmj65oz92000gwn0rszs1qs14"
slug: "turn-your-photo-into-a-simpsons-scene"
source: "https://github.com/f/prompts.chat"
source_url: "https://prompts.chat/prompts/turn-your-photo-into-a-simpsons-scene"
...
source_hash: "7e2d680b6eefacbce05e0bc36b4e33861a0b103a07cd73945250f57e768bbe49"
upstream_updated_at: "2025-12-21T11:21:40.716Z"
---
# 将您的照片变成辛普森一家场景

> 来源：[prompts.chat](https://github.com/f/prompts.chat)  
> 上游页面：[turn-your-photo-into-a-simpsons-scene](https://prompts.chat/prompts/turn-your-photo-into-a-simpsons-scene)  
...
将您上传的照片重新创建为经典《辛普森一家》中可信的剧照，转换每个人和任何动物，同时保留准确的数量、姿势和构图。背景和道具采用了类似斯普林菲尔德的外观，具有干净的卡通阴影，没有文字或水印。

## 使用场景

- 用于未分类相关任务的 AI prompt 输入。
- 用于图像生成模型的画面描述、风格控制和视觉创意生成。
- 适合围绕 Nano Banana、Art 等主题快速生成可复用结果。
...
```md
使用上传的照片作为构图和主题的唯一参考。将其重新创建为“辛普森一家”（经典季节外观）中干净、可信的静态框架，并具有一致的、精确的角色设计和背景绘画。
...
- 着色：只有最小的赛璐珞风格的着色，没有真实的阴影或纹理。

动物转换规则（显示准确）
- 将每只动物转换成类似辛普森一家的版本：
  - 简化的体型、大胆的轮廓、扁平的色彩
  - 富有表现力但简单的脸：圆点瞳孔，最小的口吻细节
- 以简化的形式保持物种的可读性并保留独特的标记（斑点、毛皮色块）。
...
- 不要更改位置类型（不要将其移动到 Moe’s、Kwik-E-Mart 或 Simpsons house，除非原始位置已与此类位置匹配）。
...
| Upstream URL | [turn-your-photo-into-a-simpsons-scene](https://prompts.chat/prompts/turn-your-photo-into-a-simpsons-scene) |
| Category | Uncategorized (`uncategorized`) |
| Type | `IMAGE` |
| Tags | Nano Banana, Art |
| Contributors | semihkislar |
| Updated At | 2025-12-21T11:21:40.716Z |
