...
创建普拉提工作室场景的逼真图像，捕捉运动女性锻炼后的姿势。图像注重自然光和逼真的纹理，同时保持柔和、优雅的氛围。确保身份保留和真实比例，无需徽标或文本。
...
```md
{
  "类别": "PILATES_STUDIO_SOFT_DAYLIGHT",
  “身份锁”：{
    “启用”：正确，
    “优先级”：“ABSOLUTE_MAX”，
    "instruction": "保留准确的参考身份和面部比例。仅限 21 岁以上成人。"
  },
  “主题”：{
  ...
  “技术细节”：{
    ...
    "noise": "低到轻微",
    “模式变体”：{
      "amateur": "手机偷拍取景，轻微噪音，轻微倾斜",
      "pro": "编辑健身外观、清晰的微对比、干净的曝光"
    }
  },
  “约束”：{
    “仅限成人”：正确，
