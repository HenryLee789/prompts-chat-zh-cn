---
id: "cmkhhzn8g0004ie04ifki85ou"
slug: "customizable-job-scanner"
source: "https://github.com/f/prompts.chat"
source_url: "https://prompts.chat/prompts/customizable-job-scanner"
...
source_hash: "6a99ef55ecc4c3e54e78c97178baaf4b21e5833f7c34f9418966798d9e1f8103"
upstream_updated_at: "2026-02-17T22:17:12.701Z"
---
# 可定制的作业扫描仪

> 来源：[prompts.chat](https://github.com/f/prompts.chat)  
> 上游页面：[customizable-job-scanner](https://prompts.chat/prompts/customizable-job-scanner)  
...
- **版本 1.8：**  
  在顶部添加了可选的“恢复自动解压模式”，以进行惰性/快速设置。人工智能从提供的简历文本中提取技能/经验。更新了使用提示。
- **版本 1.9（之前的稳定版本）：**  
  - 在末尾添加了可选的“如果不匹配，建议调整”说明。  
  - 添加了“扇区中的通用标签”后备列表以进行精简提取。  
  - 使输出表可以选择按发布日期降序排序。  
  - 在恢复自动提取模式下：人工智能必须在显示结果之前报告提取的关键事实和任何添加的标签。
- **版本 2.0（当前修订版本）：**  
...
## 顶部指令（运行提示时将其放在最开头）
“充当我专门的实时求职侦察员，具有当前的网络浏览和搜索访问权限。  
第一：【如果使用简历自动提取模式：从粘贴的简历文本中提取并总结我的技能、经验、成就和技术堆栈。在显示任何作业结果之前报告提取摘要，包括置信度（专家/强/推断）。]  
...
- 跨人工智能测试；如果结果太少→降低阈值，扩展窗口，添加相邻的标题/标签。  
...
按发布日期降序（最近的在前）对表进行排序，然后按匹配百分比降序排序。  
删除重复项（相同标题+公司）。  

将 90% 以上的匹配项放在顶部的单独部分中，称为 **热门匹配项 (90%+)**，并以粗体行或清晰突出显示。
...
| Upstream URL | [customizable-job-scanner](https://prompts.chat/prompts/customizable-job-scanner) |
| Category | Uncategorized (`uncategorized`) |
| Type | `TEXT` |
| Tags | Prompt Engineering |
| Contributors | thanos0000 |
| Updated At | 2026-02-17T22:17:12.701Z |
