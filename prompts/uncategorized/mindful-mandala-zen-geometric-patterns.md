...
为冥想、正念、健康应用程序和数字艺术生成美丽、复杂的曼陀罗和禅宗几何图案。非常适合在没有任何人物的情况下创建神圣的几何形状、对称图案和平静的视觉效果。
...
Generate beautiful, intricate mandala and zen geometric patterns for meditation, mindfulness, wellness apps, and digital art. Perfect for creating sacred geometry, symmetrical patterns, and calming visuals without any human figures.
