...
用于让 AI 围绕「对我们有好处」执行通用 AI 任务执行任务。它会保留原始角色、任务目标、约束条件和输出要求，适合直接复制给 ChatGPT、Claude、Gemini 等对话式 AI 使用。
...
```md
{ "subject": { "description": "一位受韩国美妆启发的年轻成年女性，有着柔软的鹅蛋脸和水润的肌肤，坐在安静卧室里皱巴巴的床上，平静亲密的闺房氛围，没有明显的裸体。", "mirror_rules": [], "age": "20 岁出头到中期", "express": { "eyes": { "look": "温柔放松", "energy": "温柔，略带梦幻", "direction": "看着镜头" }, "mouth": { "position": "微妙的闭唇微笑", "energy": "温暖，安静的自信" }, "overall": "温柔，不做作，亲密但有品味" }, "face": { "preserve_original": true, "makeup": "极简韩妆，自然直眉，淡眼线，自然睫毛、透明光泽的嘴唇、干净的肤色和自然的高光" }, "hair": { "color": "深棕色到黑色", "style": "宽松的低发髻，几缕纤细的发丝勾勒出脸部轮廓", "effect": "略显凌乱，生活中的柔软" }, "body": { "frame": "柔软的曲线身材", "waist": "自然的腰线，不过分收紧", "chest": "丰满的胸围，自然形状", "legs": "坐着时可见粗壮的大腿", "skin": { "visible_areas": "肩膀、锁骨、上胸部、中腹部、大腿", "tone": "浅暖米色", "texture": "光滑，毛孔细腻，光泽自然", "lighting_effect": "窗户光在脸颊、肩膀和锁骨" } }, "pose": { "position": "坐在床上，躯干面向镜头", "base": "双手放在背后，就像解开文胸肩带/内衣一样，肩膀稍微前倾", "overall": "头部微微倾斜，放松的姿势" }, "clothing": { "top": { "type": "米色蕾丝文胸", "color": "柔软裸米色", "details": "精致的蕾丝质地，细肩带滑落到肩膀下方，搁在上臂上，中间有小蝴蝶结", "effect": "柔软的女性内衣，有品位" }, "bottom": { "type": "配套蕾丝内裤", "color": "柔软的裸米色", "details": "蕾丝边，最小的接缝", "effect": "凝聚力内衣套装" } } }, "accessories": { "headwear": "none", "jewelry": "none", "device": "none", "prop": "none" }, "photography": { "camera_style": "逼真的智能手机肖像，自然的社交媒体闺房照片", "angle": "略高于眼睛水平，面向拍摄对象", "shot_type": "中景到大腿以上，居中取景，略显随意offset", "aspect_ratio": "2:3 垂直", "texture": "干净但自然，温和的手机锐化，微妙的传感器噪音，逼真的皮肤细节", "lighting": "来自侧面的凉爽柔和的窗户日光，柔和的阴影，无刺眼的闪光", "depth_of_field": "适中，主体锐利，背景稍微柔化" }, "background": { "setting": "最小的卧室内部", "wall_color": "冷光灰色/白色", "elements": [ "皱巴巴的米色床单", "简单的床边", "带网格/网格图案的大窗户", "柔和的蓝灰色天空和外面远处的建筑物" ], "气氛": "安静、私密、日常现实主义", "照明": "房间环境昏暗，窗户光线强烈" }, "the_vibe": { "energy": "低沉而稳定、亲密平静", "心情": “柔和、宁静、略带忧郁的蓝色时刻静谧”、“审美”：“K-beauty 干净的光泽+简约的卧室现实主义”、“真实性”：“不完美的床上用品和自然的姿势”、“亲密”：“亲密但尊重，就像轻轻捕捉的私人时刻”、“故事”：“她刚刚调整完靠近窗户的带子，安静的光线在她的皮肤上停留了一秒钟”， "caption_energy": "安静的自信，温柔的柔软" }, "constraints": { "must_keep": [ "窗光下的水润自然肌肤", "柔和的鹅蛋脸，五官温柔", "有光泽的嘴唇和迷你

al K-beauty 妆容”、“深色头发扎成松散的低发髻，纤细的股线”、“米色蕾丝内衣套装（胸罩和内裤）”、“胸罩肩带滑落到肩膀以下”、“坐在皱巴巴的米色床上”、“带有网状/网格图案和蓝灰色户外色调的大窗户”、“有品味、不露骨的亲密感”]、“避免”：[“显式”裸体”、“可见的乳头或生殖器”、“浓妆艳抹”、“强烈的闪光灯”、“过度喷漆的塑料皮肤”、“繁忙的装饰卧室”、“工作室背景外观”] }、“否定提示”：[“nsfw”、“露骨”、“裸体”、“色情”、“乳头可见”、“乳晕”、“生殖器”、“透视”内衣”、“极度乳沟”、“过度性感的姿势”、“硬闪光”、“油皮过度光泽”、“塑料皮肤”、“娃娃脸”、“动漫”、“卡通”、“低分辨率”、“模糊”、“水印”、“文字”、“标志”] }
