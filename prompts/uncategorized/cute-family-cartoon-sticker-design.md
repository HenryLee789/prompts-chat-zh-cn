...
```md
{
  ...
  “详细信息”：{
    ...
    "location": "一个舒适、稍微风格化的家庭环境 - 也许是客厅或家庭办公室。背景元素简约而柔和：舒适的扶手椅、带有抽象代码行的发光笔记本电脑屏幕，也许地板上还有一个色彩缤纷的小玩具。整体设置感觉温暖而诱人。",
    "lighting": "柔和、漫射的室内照明，设计明亮、清晰，没有刺眼的阴影，类似于儿童书籍插图。一切都光线充足，清晰可见。",
    "camera_angle": "一个中特写，重点关注三个主题及其相互作用。对于贴纸来说，构图应该是紧凑的圆形（或容易裁剪成一个），三个都突出。（1:1构图）。",
    "emotion": "爸爸：滑稽地慌乱/专注；宝宝：快乐/调皮；妈妈：平静/有趣。",
    "costume": "简单、舒适的家居服。爸爸穿着图案 T 恤（可能带有微妙的科技参考），妈妈穿着柔软的毛衣或衬衫，宝宝穿着可爱的图案连体衣或简单的婴儿衣服。颜色明亮且友好。",
    "color_palette": "欢快而诱人的柔和柔和的调色板与更明亮、吸引人的颜色混合在一起。想想温暖的黄色、柔和的蓝色、薄荷绿和玫瑰粉色。大胆、干净的轮廓。",
