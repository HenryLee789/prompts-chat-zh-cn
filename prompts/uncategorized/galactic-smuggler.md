...
    "location": "一个尘土飞扬的外星星球上的一个熙熙攘攘、布满砂砾的太空港。可见元素包括一艘定制改装的星舰的金属船体（有明显的烧焦痕迹和修理痕迹）、一箱箱非法货物、发光的数据终端和在背景中旋转的外星物种。天空是一种独特的外星颜色，可能有多个卫星。",
    "lighting": "动态的混合照明。来自太空港的刺眼的人造光（霓虹灯、泛光灯）与来自外星太阳的自然的、通常是彩色的光相结合。在金属表面和主体的装备上形成强烈的对比和亮点。空气中可见尘埃微粒。",
    "camera_angle": "中景到全身，拍摄对象随意靠在星舰上。稍微低角度强调飞船的大小和拍摄对象的自信。背景很忙碌，但稍微失焦，以保持对拍摄对象的注意力。（1:1构图）。",
    "emotion": "自信、精明、略带淘气、自信。",
    "costume": "破旧、实用但时尚的未来派服装：带有补丁和集成技术的耐用飞行夹克、坚固的工装裤和加固靴子。一条带有各种小玩意和皮套爆能枪的实用腰带。也许是一条独特的围巾或头巾。头发稍微凌乱但很酷。",
    "color_palette": "混合了尘土飞扬的大地色调（棕色、棕褐色、褪色的绿色）与来自科技和外星人标牌的充满活力的外星色彩（电光蓝、鲜艳的紫色、霓虹黄）。船上的金属银/青铜色。天空可能是不寻常的橙色或红色阴影。",
    "atmosphere": "冒险、熙熙攘攘、有点危险，并且充满了隐藏的机会。空气中充满了商业和非法交易的能量。一种自由和生活在边缘的感觉。",
    "subject_expression": "自信、会心的傻笑，或者随意、放松的微笑。眼睛锐利而善于观察，也许看起来有点偏离镜头，好像在寻找麻烦或机会。",
    "subject_action": "随意靠在他们的星际飞船的船体上，一只手可能放在爆能枪套或控制面板上。另一只手可能拿着一个未来派的数据板或一种奇特的外星饮料。肢体语言很放松，但已经准备好了。",
    "environmental_elements": "微妙的废气或蒸汽从星舰中升起。其他独特的外星飞船起飞或着陆的远处轮廓。背景中有双头外星人或机器人。地面布满灰尘，显示出超速飞行器的轮胎痕迹。"
  }
}
```
