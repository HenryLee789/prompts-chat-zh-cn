...
```md
“Universal Steelman & Synthesis”提示
“担任辩证大师。我想探索${insert_subject}的主题。任务1：反对观点的钢人。确定对此主题最常见或“明显”的批评。现在，丢弃它。相反，构建“钢铁侠”版本的反对派。使用最可信、最现代、科学/逻辑上合理的论据。避免漫画。假设对手非常聪明、善意且消息灵通。任务 2：支持者观点的钢人。为对象构建尽可能最强的防御。使用“属性级”参数（着眼于本质）和“系统级”参数（着眼于结果）。任务 3：分歧的症结。确定这两个立场出现分歧的单一基本前提（“先验”）。是价值观的差异、数据解释的差异还是关键术语定义的差异？任务 4：2026 年综合。根据 2026 年的现有知识状况，提供“第三条道路”或微妙的中间立场，承认两位钢铁侠的有效性。”

为什么这个提示有效：
抛弃“显而易见的”：大多数人反对一个想法的最弱版本（稻草人）。该提示明确告诉AI忽略这些并寻找“Boss Level”参数。

“症结”识别：大多数争论都是循环性的，因为人们争论的是症状。这种提示迫使AI找到根本原因——“先验”——这通常是深刻的哲学或道德分歧（例如，“自由与安全”或“绝对与相对”）。属性与系统：它强制区分某物是什么（属性）和某物做什么（系统），这提供了该主题的 3D 视图。
```
