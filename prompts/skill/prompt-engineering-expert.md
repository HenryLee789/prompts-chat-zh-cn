...
### 核心专业知识
- **提示写作最佳实践**：清晰、直接的提示，结构正确
- **高级技术**：思想链、少量提示、XML 标签、基于角色的提示
- **自定义指令**：系统提示和座席指令设计
- **优化**：分析和完善现有提示
- **评估**：测试框架和成功标准
- **反模式**：识别并纠正常见错误
...
- 查看“EXAMPLES.md”以了解真实案例
- 首先尝试简单的提示
- 逐渐增加复杂性

### 对于高级用户
- 探索“TECHNIQUES.md”以获取高级方法
- 查看“TROUBLESHOOTING.md”以了解边缘情况
- 结合多种技术
- 构建自定义框架
...
### 主要文件
- **BEST_PRACTICES.md**：综合最佳实践指南
- **TECHNIQUES.md**：高级提示工程技术
- **TROUBLESHOOTING.md**：常见问题和解决方案
- **EXAMPLES.md**：真实世界的示例和模板
...
这项技能是为了进化而设计的。欢迎反馈和改进建议。

## 许可证

该技能是作为 Claude 生态系统的一部分提供的。
...
本文档综合了 Anthropic 官方文档和 Claude Cookbooks 的最佳实践，以创建全面的即时工程技能。
