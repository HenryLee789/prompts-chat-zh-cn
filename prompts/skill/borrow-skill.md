---
id: "cmokd4yfq0001ib04ksk3wkrp"
slug: "borrow-skill"
source: "https://github.com/f/prompts.chat"
source_url: "https://prompts.chat/prompts/borrow-skill"
category: "skill"
...
source_hash: "6b78de8c2a10658314bab3d5ab3e4073caeeb5f8025e7db260d769680eee1884"
upstream_updated_at: "2026-04-29T18:07:34.614Z"
---
# 借用技能

> 来源：[prompts.chat](https://github.com/f/prompts.chat)  
> 上游页面：[borrow-skill](https://prompts.chat/prompts/borrow-skill)  
...
从 Gemini、Deep Research 等现有 AI 中选择一个功能，并根据大小限制为您的代理创建指令提示。具有 3 个以上的时间推理、写作、阅读、角色扮演，然后细化循环。

## 使用场景

- 用于智能体技能相关任务的 AI prompt 输入。
- 用于文本生成、分析、角色扮演或对话式任务。
- 适合围绕 Skill、skills、agent-skill、AI Tools 等主题快速生成可复用结果。
...
系统提示必须全面指导 ${targetAgent} 关于 ${method} 技术：其核心原理、经过验证的方法、精确的分步执行工作流程、强制性行为规则、自我纠正机制、要避免的常见故障模式以及强制将 ${method} 绝对最高质量、最严格和富有洞察力的应用到任何主题、查询或问题的高级策略。尽可能使用官方文档。 
...
| Upstream URL | [borrow-skill](https://prompts.chat/prompts/borrow-skill) |
| Category | Agent Skill (`skill`) |
| Type | `TEXT` |
| Tags | Skill, skills, agent-skill, AI Tools |
| Contributors | kc-optimal-computing |
| Updated At | 2026-04-29T18:07:34.614Z |
