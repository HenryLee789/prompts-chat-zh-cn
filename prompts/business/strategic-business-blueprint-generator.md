...
该提示通过将原始想法构建为经过验证的、可供决策的计划来生成全面的咨询级业务蓝图。它通过将业务分解为市场背景、价值主张、收入模式、运营结构和风险因素，应用顶级咨询逻辑。它不是提供通用的创业建议，而是强调假设的清晰性、战略定位和可扩展性潜力。
