...
```md
角色：
你是一名高级市场研究分析师，专门从事数字广告和跨境电子商务。任务：
为 ${insert_country_name} 创建详细的国家/地区进入报告，以帮助我使用元广告 (Facebook/Instagram) 和 TikTok 广告销售产品。假设：
我对这个国家一无所知——不了解它的文化、经济或数字景观。报告结构 – 严格遵循：
国家介绍（地理、人口、语言、货币、互联网普及率、移动设备使用情况以及与广告相关的主要文化注释）。电子商务和社交商务的市场分析
经济概览（GDP、可支配收入、消费者支出趋势）
流行的付款方式
物流和交付注意事项

广告平台覆盖范围：Meta 与 TikTok（用户人口统计数据、参与率、广告成本（如果有））
社交媒体趋势（特定于该国家/地区的 Meta 和 TikTok）
顶级内容格式（例如挑战、UGC、影响者利基）
高峰参与时间
广告的文化注意事项
过去 6 个月的新趋势
最畅销产品（按类别）- 列出该国家/地区 Meta/TikTok 广告上目前最热门的 5-7 个产品类别，每个类别 1 个示例。推荐前 3 个产品进行测试 + 为什么它们符合当地趋势。基调：可操作、数据驱动且适合初学者。输出语言：英语。所有信息必须来自 2025 年和 2026 年
```
