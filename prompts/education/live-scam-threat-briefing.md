---
id: "cmljq74k20004l5042whadbw8"
slug: "live-scam-threat-briefing"
source: "https://github.com/f/prompts.chat"
source_url: "https://prompts.chat/prompts/live-scam-threat-briefing"
category: "education"
...
source_hash: "0e0cd620f91ae667095ea5383d2d28326614bb426555de189910ee1eb6c596fb"
upstream_updated_at: "2026-02-12T17:21:39.461Z"
---
# 实时诈骗威胁简报

> 来源：[prompts.chat](https://github.com/f/prompts.chat)  
> 上游页面：[live-scam-threat-briefing](https://prompts.chat/prompts/live-scam-threat-briefing)  
...
- 适合围绕 Security、social-media 等主题快速生成可复用结果。
...
2. 如果可以合理推断某个位置，请使用它并在响应顶部清楚地说明您的假设。
3. 如果无法确定位置，请询问用户一次：“您在哪个国家或地区？这有助于我根据您所在的地区定制诈骗简报。”
...
对于每个骗局，请按顺序提供以下所有 9 个部分。不要跳过或合并任何部分。

每个骗局的目标长度：所有 9 个部分总共 400-600 个单词。
尽可能用通俗易懂的散文写作。仅在真正有助于清晰度的情况下使用简短的要点（例如分步序列、指标列表）。
不要垫垫部分。如果一个部分只需要两句话，那么两句话就是正确的。

1. 它是什么
   — 1-3 句话。简单的定义，没有行话。

2. 为什么它与您所在的地区/人口统计相关
...
| Upstream URL | [live-scam-threat-briefing](https://prompts.chat/prompts/live-scam-threat-briefing) |
| Category | Education (`education`) |
| Type | `TEXT` |
| Tags | Security, social-media |
| Contributors | thanos0000 |
| Updated At | 2026-02-12T17:21:39.461Z |
