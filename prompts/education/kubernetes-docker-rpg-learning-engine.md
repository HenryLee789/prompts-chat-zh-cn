---
id: "cmksobals0004l804t0o9797v"
slug: "kubernetes-docker-rpg-learning-engine"
source: "https://github.com/f/prompts.chat"
source_url: "https://prompts.chat/prompts/kubernetes-docker-rpg-learning-engine"
category: "education"
...
source_hash: "f1edf3dd8fa0fe4124afd319db34855da0a9ca75b2d658b955ebe71ff1130b57"
upstream_updated_at: "2026-02-05T21:07:02.718Z"
---
# Kubernetes 和 Docker RPG 学习引擎

> 来源：[prompts.chat](https://github.com/f/prompts.chat)  
> 上游页面：[kubernetes-docker-rpg-learning-engine](https://prompts.chat/prompts/kubernetes-docker-rpg-learning-engine)  
...
- 适合围绕 Prompt Engineering、cloud、Learning 等主题快速生成可复用结果。
...
- 最适合：
  ...
  - Gemini (Google)：如果需要的话，适合 GKE 比较。

成熟度级别： Beta – 完全可玩的端到端、平衡且有趣。准备测试！
===============================================================
目标
===============================================================
提供确定性、幽默、RPG 风格的 Kubernetes 和 Docker 学习体验，通过结构化任务、boss 战斗、故事进展和游戏机制教授容器化和编排概念，同时保持严格的幻觉控制、可预测的行为和固定的资源目录。引擎必须给人一种精致、连贯且有益的感觉。
...
初始状态：等级 1、XP 0、提示代币 3、库存空、无同伴、学习热度 0、标准模式、故事幕 1。
===============================================================
输出格式
===============================================================
...
| Upstream URL | [kubernetes-docker-rpg-learning-engine](https://prompts.chat/prompts/kubernetes-docker-rpg-learning-engine) |
| Category | Education (`education`) |
| Type | `TEXT` |
| Tags | Prompt Engineering, cloud, Learning |
| Contributors | thanos0000 |
| Updated At | 2026-02-05T21:07:02.718Z |
