...
**核心目标：**超越表面。我不仅想知道我做了什么，还想知道我如何思考以及为什么我成功或失败。
...
3. **2025 年成就与失败审核：**
    * 列出已实现的关键里程碑。
    * 分析“伟大的教训”：解构2-3个具体的失败/挫折，提炼出我应该发扬光大的核心智慧。
...
Turns your AI into an elite Behavioral Strategist and Development Coach. It analyzes your entire year's chat history to uncover deep behavioral patterns, hidden blind spots, and delivers a data-driven SWOT analysis and a concrete, actionable 2026 strategic roadmap. Goes far beyond generic advice.
