---
id: "cmmxuodju000djs041t40ypq4"
slug: "legal-risk-minimization-tool-for-freelancers"
source: "https://github.com/f/prompts.chat"
source_url: "https://prompts.chat/prompts/legal-risk-minimization-tool-for-freelancers"
category: "vibe"
...
source_hash: "daaeea2ded60dbeeb622321977ddce572fda32c1adec0a52a5c2a8160fdf503c"
upstream_updated_at: "2026-03-19T19:15:31.098Z"
---
# 自由职业者法律风险最小化工具

> 来源：[prompts.chat](https://github.com/f/prompts.chat)  
> 上游页面：[legal-risk-minimization-tool-for-freelancers](https://prompts.chat/prompts/legal-risk-minimization-tool-for-freelancers)  
...
自由职业者和小型经营者知道他们应该有更好的合同和更明确的协议，但发现法律的复杂性令人瘫痪。一种可以在 5 分钟内生成足够好的合同的工具可以消除这种瘫痪状态，并切实减少特定的焦虑。
...
```md
为自由职业者构建一个名为“Shield”的法律风险降低工具——一个合同生成器和审查器，可以减少常见的法律风险。

重要提示：此应用程序的每个页面都必须显示明确的免责声明：“此工具仅提供模板和一般信息。这不是法律建议。使用前请与合格的律师一起审查所有文件。”

核心特点：
- 合同生成器：用户输入项目类型（网页开发/文案/设计/咨询/摄影/其他）、客户类型（个人/小型企业/企业）、付款条件（固定/里程碑/保留）、大致项目价值以及 3 个通俗语言的自定义交付成果。 [LLM API] 生成完整的合同，涵盖范围、IP 所有权、付款计划、修订政策、逾期付款罚款、保密性和终止 — 格式为干净的 DOCX
- 合同审阅者：用户粘贴传入的合同。 AI 突出显示 5 个最重要的条款（按风险排名），标记任何异常或不对称的内容，并针对每个标记的条款建议特定的替代措辞
- 风险雷达：用户用 3 句话描述他们的自由职业业务 - 人工智能通过对每个风险和缓解步骤的一段解释来识别他们最重要的 5 个法律风险领域
- 模板库：10 种预建合同类型，全部可作为 DOCX 下载并可在任何文字处理器中编辑
- NDA 生成器：输入双方名称、保密范围和持续时间 — 在 30 秒内生成相互 NDA

Stack：React，[LLM API] 用于生成和审核，docx-js 用于 DOCX 导出。专业、值得信赖的设计——这可以处理严肃的事情。
```
...
| Upstream URL | [legal-risk-minimization-tool-for-freelancers](https://prompts.chat/prompts/legal-risk-minimization-tool-for-freelancers) |
| Category | Vibe Coding (`vibe`) |
| Type | `TEXT` |
| Tags | None |
| Contributors | mmanisaligil |
| Updated At | 2026-03-19T19:15:31.098Z |
