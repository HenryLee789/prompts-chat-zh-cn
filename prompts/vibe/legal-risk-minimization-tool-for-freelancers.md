...
```md
为自由职业者构建一个名为“Shield”的法律风险降低工具——一个合同生成器和审查器，可以减少常见的法律风险。重要提示：此应用程序的每个页面都必须显示明确的免责声明：“此工具仅提供模板和一般信息。这不是法律建议。使用前请与合格的律师一起审查所有文件。”
...
- 风险雷达：用户用 3 句话描述他们的自由职业业务 - AI通过对每个风险和缓解步骤的一段解释来识别他们最重要的 5 个法律风险领域
