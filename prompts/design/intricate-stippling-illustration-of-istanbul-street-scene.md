...
该提示指导创建一个非常详细的手绘插图，描绘伊斯坦布尔繁华的街景，捕捉塔克西姆广场和独立大道的精髓。它强调使用点画技术来渲染错综复杂的城市景观，融合历史和现代元素，并结合充满活力的强调色来突出关键特征。该插图旨在通过微观细节和强烈的视觉故事讲述来传达密集的城市氛围。
...
* 分析界面问题并提出改进方向
* 把需求转化为可执行的设计说明
* 围绕 Art、design、creative 等主题生成结构化结果
...
```md
高度详细的手绘插图，描绘了伊斯坦布尔繁忙的街道交叉口，灵感来自塔克西姆广场/独立大道的人流，里面挤满了向多个方向移动的密集人群。整个场景采用点画/点画技术（笔墨风格）创建，紧密排列的黑色墨点形成阴影、纹理和大气深度。建筑物反映了分层的伊斯坦布尔城市景观：历史悠久的奥斯曼时代建筑与现代店面、咖啡馆、电车线路和密集的垂直标牌融为一体。表面布满土耳其商店招牌、面包店招牌、街头广告、海报和照明的城市细节，将当代城市生活与文化遗产融为一体。该构图采用了略微自上而下的广角视角，具有强烈的深度线索。前景充满了拥挤的行人，中景显示了主要十字路口和电车走廊，背景延伸到密集的城市街区和天际线轮廓。使用单色黑白点画作为基础渲染，并使用选择性的鲜艳强调色（红色、蓝色、绿色、黄色）突出显示标志、电车元素、旗帜和关键视觉焦点。插图应该感觉非常复杂，具有微观细节、分层纹理和强烈的视觉故事性。包括大气的城市密度、微小的人物、微妙的运动线索和复杂的建筑变化。风格融合了传统的欧洲点画雕刻与现代都市插画美学。

-- 超详细 -- 8k -- 高分辨率 -- 错综复杂 -- 手绘 -- 墨水插图 -- 点画 -- 点阴影 -- 城市场景 -- 拥挤的城市 -- 伊斯坦布尔
```
