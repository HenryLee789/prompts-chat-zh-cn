...
此提示将指导你在现代公寓中创建逼真且细致的镜像自拍图像场景。专注于捕捉特定的衣柜细节、灯光和构图，以保持真实性。它包括有关姿势、环境和美学方面的说明，以确保逼真的表现。
...
```md
“现代公寓内部的镜子自拍场景。一位年轻女子，留着自然卷曲的浅棕色长发，戴着深色棒球帽（带子在后面可见），穿着黑色短袖足球衫，上面有粉色字母和数字“10”，下穿黑色高腰紧身裤。她背对着镜头，面向镜子；她的脸几乎看不见（后面/从后面看四分之三）。她右手拿着一部黑色智能手机，与肩同高，肘部弯曲~90°，手腕伸直，后置摄像头面向镜子，这样镜子中的手机屏幕就会显示相同的场景（手机内递归）。左臂放松地垂在身侧。相机和构图：从后面对着镜子自拍；镜头约 26–28mm 等效值，视平相机高度；纵向方向；从大腿中部到头顶上方，以球衣文字和号码为中心。房间里的日光柔和柔和；没有刺眼的阴影。环境：左边的白色门，带金属把手，狭窄的墙壁部分，通向最小厨房的开放式门口（可见高大的冰箱/烤箱柱），浅色中性墙壁，浅色地板。背景稍微柔和但可读。需要保留的衣橱细节：球衣上的文字“MESSI”，采用圆形粉红色字母，上面有一个大的粉红色“10”；粉色线条风格一致；球衣版型稍宽松；帽子颜色深；打底裤哑光黑色；头发长度达到中后部，有一些松散的卷发。姿势和微角度：头稍微向右倾斜，帽檐稍微向下倾斜；肩膀放松；骨盆与镜子成直角；脊柱中立。右手握紧，指尖在手机的远端可见；手机边缘与镜框平行；电话大致位于脊柱线的中心。灯光：室内自然光柔和，白平衡中性，无闪光，无偏色。反射在物理上是正确的，没有重复或错位。审美：干净、真实、未经过滤、逼真的皮肤和织物纹理，重点关注球衣字母和电话；最小的颗粒。裁剪和长宽比：主要3:4（肖像）；安全替代方案 9:16 和 4:5 在框架中保留完整的球衣文字和号码。”
一致性锁（不要更改）：
同一个女人：头发长度、颜色、波浪图案；深色棒球帽，带后带；黑色球衣，粉色“MESSI”+“10”；黑色打底裤；右手握住手机，与肩同高；左臂放松；从后面对着镜子自拍；公寓/厨房布局；带金属把手的门；相机整体高度≈视线高度；电话递归在屏幕上可见。保持比例和体型；没有减肥/拉长。保持球衣字母的颜色和排版准确；无需重新设计。维护环境几何形状和对象放置。
```
...
This prompt guides you to create a realistic and detailed mirror-selfie image scene in a modern apartment. Focus on capturing specific wardrobe details, lighting, and composition to maintain authenticity. It includes instructions on pose, environment, and aesthetic aspects to ensure a true-to-life representation.
