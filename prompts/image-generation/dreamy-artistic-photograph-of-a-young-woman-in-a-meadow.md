...
这个提示会生成一张梦幻般的艺术照片，照片上是一位年轻女子走过草地。它以温暖、复古的色调捕捉怀旧和忧郁的情绪。该场景采用自然光，具有独特的旋转散景效果，以电影风格突出主题。
...
```md
{
  ...
  “组成”：{
    "camera_angle": "眼睛水平拍摄",
    "depth_of_field": "浅",
    "focus": "一个穿着红色连衣裙的年轻女子",
    “取景”：“这个女人的构图稍微偏离中心，以侧面的方式走过场景。背景呈现出强烈的旋转散景，自然地框住并隔离了拍摄对象。”
  },
  "description_short": "一位穿着红色短裙和白色运动鞋的年轻女子侧身走过花田，背景中有明显的旋转模糊效果。",
  “环境”：{
    "location_type": "室外",
    "setting_details": "郁郁葱葱的绿色田野或花园，长满白色和黄色的野花，很可能是雏菊。整个背景严重失焦，形成抽象的漩涡图案。",
    "time_of_day": "下午",
    “天气”：“多云”
  },
  “照明”：{
  ...
  “叙述元素”：{
    "character_interactions": "这名女子很孤独，看上去陷入了沉思。",
    "environmental_storytelling": "空灵、旋转的花卉背景暗示着梦境或记忆，强调了拍摄对象的内省状态。她充满活力的红色连衣裙与柔和的绿色环境形成鲜明对比，突出了她作为场景的情感中心。",
    "implied_action": "女人从一个地方走到另一个地方，暗示着一段旅程、一段沉思的时刻，或者是逃离大自然。"
  },
  “对象”：[
    “女人”，
    “红裙子”，
  ...
  “人”：{
    ...
    "clothing_style": "波西米亚浪漫；带有荷叶边细节的飘逸红色短裙，搭配休闲白色运动鞋。",
    “计数”：“1”，
    “性别”：[
      “女”
    ]
  },
  "prompt": "一张梦幻般的艺术照片，一位年轻女子的棕色头发随风飘扬，侧影走过雏菊草地。她穿着鲜艳的红色短裙和白色运动鞋。图像景深非常浅，在背景中营造出标志性的旋转散景效果。灯光柔和自然，具有温暖、复古的色彩等级。情绪沉思而忧郁，捕捉到转瞬即逝的瞬间。内省。”,
  “风格”：{
    "art_style": "电影风格",
    “影响”：[
      “印象派”，
  ...
  "use_case": "艺术图库摄影、编辑时尚、书籍封面或专门镜头效果的数据集。",
