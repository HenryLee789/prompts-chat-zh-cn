...
- 不要应用 Instagram 等现代滤镜。
- 避免“光滑”或“塑料皮肤”效果。
- 避免使用霓虹色、过度饱和度或锐化伪影（例如白色光晕）。
- 防止出现数字绘画或 3D 插图。

**最终输出质量：**

- 实现逼真、博物馆品质的效果，具有超清晰的细节（8k 分辨率风格）和绝对的历史保真度。
```
...
High-precision conservative restoration and historical colorization of a degraded vintage photograph
