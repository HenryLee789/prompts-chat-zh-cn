...
创建一张逼真的旅行影响者图像，捕捉一位土耳其长相的成年女性在黄金时间的海滩散步时的样子。该场景包括特定的造型和环境细节，以唤起梦幻、无忧无虑和温暖的心情。确保遵守无徽标或文本等限制，同时保持高水平的真实性和技术质量。
...
```md
{
  "类别": "BEACH_WALK_GOLDEN_HOUR_FULLBODY",
  “主题”：{
    "demographics": "成年女性，21-29岁，土耳其长相，旅游影响者氛围。",
    “头发”：{
      “颜色”：“深棕色”，
      "style": "松散的波浪，随风飘扬",
      "texture": "自然股线，飞扬",
    ...
    “脸”：{
      "eyes": "快乐，在阳光下微微眯眼",
      "skin_details": "逼真的质感，阳光亲吻的光泽（不油腻）",
      "makeup": "简约海滩妆容"
    },
    “服装”：{
      "outfit": "亚麻连衣裙或沙滩罩衫（无徽标）",
      "fabric": "亚麻编织可见，皱纹柔和",
      "movement": "衣服下摆自然移动"
    },
    “配件”：{
  ...
  “姿势”：{
    "type": "全身行走坦诚",
    "orientation": "沿着海岸线的中间台阶",
    "hands": "一只手握住衣服下摆，另一只手将头发向后梳",
    "gaze": "低头大笑，然后看向相机氛围",
    "position": "无忧无虑、放松"
  },
  “设置”：{
