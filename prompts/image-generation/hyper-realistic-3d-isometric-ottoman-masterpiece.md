...
创建 ${name:Fatih Sultan Mehmet} 的 ${event:conquest of Constantinople} 的超现实 3D 等距场景，通过无尽的奥斯曼羊皮纸卷轴进行可视化。该场景应体现 ${event:the conquest of Constantinople} 的战略天才和文化意义，并采用历史悠久的奥斯曼美学。
...
粗体的奥斯曼书法拼写为 ${name:Fatih Sultan Mehmet}，并附有手稿注释，解释了他的身份和他的决定性成就，描述了 ${event:the Conquest of Constantinople (1453)} 如何重塑奥斯曼和世界历史。

• 时间和来源注释

流动的水墨时间线箭头标记了统治时期和历史背景，重点强调${event:1453}，连接埃迪尔内→君士坦丁堡等地区，象征着决定性的历史过渡。
...
展示 ${event:the Conquest of Constantinople} 执行情况的战术箭头和运动线
