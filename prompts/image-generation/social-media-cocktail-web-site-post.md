...
我需要为我的基于AI的网站发布一个可滚动的社交媒体帖子，该网站使用现有原料提供鸡尾酒配方。
...
```md
场景一：混乱
导演：9分16秒的超写实垂直镜头，拍摄的是一个幻想破灭的年轻人站在充满阳光的现代迈阿密厨房里的画面。当他们看着打开的冰箱里装满了各种水果和半空的酒瓶时，他们显得很困惑。窗外，模糊的热带迈阿密景观充满了棕榈树。强烈的热雾效果、电影般的灯光、高品质的电影摄影、8k 分辨率。焦点：优柔寡断和迈阿密的火爆气氛。场景二：明智的选择（发现）
提示：特写垂直镜头，聚焦于握着时尚智能手机的手。屏幕显示“Glugtail”网站的简约且高级的用户界面，并按下“建议菜谱”按钮。在背景中，大理石台面上可以看到失焦的原料，如新鲜酸橙、薄荷和一瓶杜松子酒。明亮、通风、专业的生活方式摄影，9:16。焦点：用户友好的界面以及 Glugtail 提供解决方案的时刻。场景三：互动干预：“调酒”（解决方案）
提示：分焦垂直图像。前景是一杯漂亮但有点太透明的水晶玻璃鸡尾酒。在它旁边，智能手机屏幕显示“修复我的饮料”弹出窗口，其中包含有关添加蜂蜜/糖浆的提示。一只手将金色的蜂蜜流倒入玻璃杯中以保持平衡。微距摄影，玻璃上的水滴，鲜艳的色彩，超细致的纹理，9:16。焦点：“鸡尾酒救援”时刻的功能和细节。场景 4：幸福的结局（完美的啜饮）
提示：一幅 9 分 16 秒的电影肖像，描绘的是一个轻松的人在豪华阳台上拿着一杯装饰精美、色彩缤纷的鸡尾酒。背景是标志性的迈阿密天际线和黄金时段的日落。这个人看起来很满意，神清气爽。温暖的发光光，散景背景，商业级饮料摄影，超写实，35mm 镜头拍摄。重点：最后的成功感和迈阿密日落的美感。
```
...
I need a scrollable social media post for my AI-based website that provides cocktail recipes using ingredients on hand.
