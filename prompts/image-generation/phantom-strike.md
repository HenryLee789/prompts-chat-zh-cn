...
```md
{
  ...
  "prompt": "你将进行图像编辑，将拍摄对象转变为超自然惊悚片中的动作英雄。图像必须逼真、高度细致，并模仿 Arri Alexa 上的帧拍摄，具有电影灯光和浅景深。该场景描绘了女性拍摄对象在废弃、被洪水淹没的地铁隧道中进行殊死搏斗。她正在与阴影战斗，阴影似乎表现为从黑暗中延伸出来的物理、烟雾缭绕的卷须。灯光是戏剧性的，突出她的皮肤纹理和溅起的水花。",
  “详细信息”：{
    "year": 《现代都市奇幻》,
    "genre": "电影照片写实主义",
