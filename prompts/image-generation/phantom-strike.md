---
id: "cmkls5mtv0001jr04f0sj2kgt"
slug: "phantom-strike"
source: "https://github.com/f/prompts.chat"
source_url: "https://prompts.chat/prompts/phantom-strike"
...
source_hash: "af14429d61693bed4633f485c945bd9f453fb825ea49c281d460b61227011e44"
upstream_updated_at: "2026-01-19T23:12:19.922Z"
---
# 幻影打击

> 来源：[prompts.chat](https://github.com/f/prompts.chat)  
> 上游页面：[phantom-strike](https://prompts.chat/prompts/phantom-strike)  
...
这是一个激烈、高辛烷值的动作镜头，讲述了一位孤独的战士在腐朽的工业环境中与超自然实体作战的故事。
...
{
  "title": "幻影打击",
  "description": "一个孤独的战士在腐朽的工业环境中与超自然实体作战的激烈、高辛烷值的动作镜头。",
  "prompt": "您将进行图像编辑，将拍摄对象转变为超自然惊悚片中的动作英雄。图像必须逼真、高度细致，并模仿 Arri Alexa 上的帧拍摄，具有电影灯光和浅景深。该场景描绘了女性拍摄对象在废弃、被洪水淹没的地铁隧道中进行殊死搏斗。她正在与阴影战斗，阴影似乎表现为从黑暗中延伸出来的物理、烟雾缭绕的卷须。灯光是戏剧性的，突出她的皮肤纹理和溅起的水花。",
  “详细信息”：{
    "year": 《现代都市奇幻》,
    "genre": "电影照片写实主义",
    "location": "一条废弃的、被水淹没的地铁维护隧道，油漆剥落，头顶工业灯闪烁。",
    “照明”：[
      “高对比度明暗对比”，
      “冷头顶荧光灯闪烁”，
      “穿过蒸汽的体积神射线”
    ],
    "camera_angle": "低角度动态动作镜头，1:1长宽比，注重运动的冲击力。",
    “情感”：[
      “猛烈”，
      “肾上腺素飙升”，
      “绝望”
    ...
    "environmental_elements": "溅起的脏水、漂浮的灰尘颗粒、半实体的阴影生物、破碎的灯具掉落的火花。",
    “主题1”：{
      "costume": "红色迷你裙、黑色无指手套、破烂的白色战术背心和重型系带作战靴。",
      "subject_expression": "用力咬紧牙关，眼睛全神贯注地锁定目标。",
...
| Upstream URL | [phantom-strike](https://prompts.chat/prompts/phantom-strike) |
| Category | Image Generation (`image-generation`) |
| Type | `IMAGE` |
| Tags | Nano Banana |
| Contributors | ersinkoc |
| Updated At | 2026-01-19T23:12:19.922Z |
