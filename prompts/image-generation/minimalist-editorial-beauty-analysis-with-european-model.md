...
创建一个简约的编辑美容分析板，展示具有特定面部特征和造型的欧洲女模特。该版块包含关于面部特征、自然造型和化妆造型的详细部分，并按照专业时尚杂志编辑布局进行设计。
...
```md
{
  "prompt": "一个极简主义编辑美容分析板，采用欧洲女模特，具有平衡的椭圆形到心形脸型和柔和的下巴轮廓。微妙的中北欧面部特征，精致的对称性和优雅的比例。中性灰色背景，干净的工作室灯光，高度真实感。\n\n顶部：正面裸脸肖像，自然的皮肤纹理，中性至冷色调，没有化妆，头发向后梳，平静的中性表情。细蓝色轮廓追踪\n\n右侧图形文本布局标题为“FACE”，带有描述面部特征的小要点：平衡的椭圆形脸型、柔和明显的颧骨、女性化而精致的下巴线、略微锥形的自然下巴、笔直到柔和轮廓的鼻梁、清澈的杏仁到圆润的眼睛和柔和的凝视。\n\n中间部分：两张标有“裸脸”的工作室肖像，一张正面视图和一张四分之三侧面，简约的欧洲编辑风格，柔和的漫射灯光，逼真的皮肤纹理和精致的面部细节。\n\n底部：两张标有“化妆”的镜面自拍风格图像，自然缎面的清新光泽皮肤，现代欧式柔和魅力妆容，柔和的腮红色调，裸粉色或柔和的玫瑰光泽嘴唇，微妙的眼线，轻柔地抬起外角，自然的睫毛，柔和的分层头发，受巴黎和米兰街头优雅启发的当代欧洲时尚造型。\n\n时尚杂志编辑布局，干净现代排版、平衡间距、柔和的中性色调、专业美妆摄影、高分辨率、逼真的皮肤纹理和自然的比例。",
  "negative_prompt": "夸张的妆容、浓重的轮廓、刺眼的阴影、卡通风格、动漫、扭曲的面部比例、过于尖锐的下巴线、低分辨率、过饱和的颜色、凌乱的布局、水印、标志、文字伪影、重复的面孔、多余的肢体",
  "style": "编辑美容摄影",
  “质量”：“高”，
  “灯光”：“工作室柔和灯光”，
  “背景”：“中性灰色”
...
Create a minimalist editorial beauty analysis board showcasing a European female model with specific facial attributes and styling. The board includes detailed sections on facial features, natural and makeup styling, and is designed in a professional fashion magazine editorial layout.
