...
创作一幅喜怒无常的电影肖像，重点关注情感深度和艺术构图。该提示将引导你拍摄一个留着深色卷发的英俊男子的特写镜头，使用柔和、戏剧性的灯光和雨纹窗户来强调忧郁和内省的氛围，以增加深度和叙事性。
...
```md
{
  ...
  “组成”：{
    ...
    "depth_of_field": "浅",
    "focus": "人的脸和眼睛",
    “取景”：“男人的脸位于中心位置，由他的深色卷发和外套领子构成。他的手位于框架右侧，增加了构图，而雨纹玻璃则充当前景层。”
  },
  "description_short": "一个喜怒无常的特写肖像，一个英俊的男人，黑卷发，专注地透过布满雨滴的窗户。",
  “环境”：{
    "location_type": "室内",
    "setting_details": "场景亲密，拍摄对象位于一块布满水滴的玻璃后面。背景昏暗且模糊，强调了男人的孤立和内省。",
    "time_of_day": "未知",
    “天气”：“下雨”
  },
  “照明”：{
  ...
  “叙述元素”：{
    "character_interactions": "尽管有窗户的物理屏障，该男子仍与观看者进行直接的眼神交流，创造了一种强大而亲密的联系。",
    "environmental_storytelling": "窗户上的雨暗示着与外界的分离，增强了渴望、孤独或沉思的主题。它创造了一种私密、阴郁的情绪。",
    "implied_action": "这个人陷入了沉思，他的手按在玻璃上，仿佛渴望另一边的某事或某人。他可能正在等待或反思过去的事件。"
  },
  “对象”：[
    “男人”，
    “窗”，
  ...
  “人”：{
    ...
    "clothing_style": "他在深色领子衬衫外面穿了一件深色、有纹理的外套，暗示着一种经典而阴沉的风格。",
    “计数”：“1”，
    “性别”：[
      “男”
    ]
  },
  "prompt": "电影般的喜怒无常的特写肖像，描绘的是一个英俊的男人，有着深色的卷发和强烈的目光。他透过布满逼真雨滴的窗户直视镜头。他的手轻轻地按在冰冷的玻璃上。灯光柔和而富有戏剧性，在黑暗、失焦的背景下突出了他的五官。气氛忧郁、沉思和浪漫。照片写实，高细节，浅景深。",
  “风格”：{
    "art_style": "现实",
    “影响”：[
      “电影肖像”，
  ...
  "use_case": "浪漫、渴望或内省主题的图库摄影；小说或电影的人物灵感；时尚或古龙水的广告。",
