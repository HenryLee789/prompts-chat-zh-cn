...
以镜子自拍美感创建详细的室内生活方式肖像，捕捉阳光照射的卧室中宁静而亲密的时刻。该场景的主角是一位年轻的成年人，其女性化的外表，简约而自然的美学风格，舒适地坐在床上。利用自然日光实现柔和逼真的视觉感受，专注于具有高保真纹理和自然光照渐变的真实感渲染。
...
```md
{
  "scene_type": "室内生活方式肖像（镜子自拍美学）",
  “环境”：{
    "location": "阳光充足的卧室，白天光线柔和、自然",
    “背景”：{
      "bed": "白色金属框架床，具有柔和的复古感，配有浅色植物图案床上用品",
      "decor": "干净、简约的风格，有几盆小盆栽、一个简单的床头柜和低调的花卉装饰",
      "windows": "大窗户，配有通风的透明窗帘，可以漫射光线并软化整个房间",
      "color_palette": "暖白色、象牙色、米色和浅中性色，带有淡淡的植物和花卉气息"
    },
    "atmosphere": "安静、亲密、舒适、透气、柔和的居住环境"
  },
  “主题”：{
    "gender_presentation": "女性",
    "approximate_age_group": "成人（21 岁以上）、青少年",
    "skin_tone": "白皙的肤色，真实、自然的皮肤纹理和细微的瑕疵",
    “头发”：{
      "color": "酷白金金发（略带冰冷色调）",
      "style": "长直发，中间部分干净，自然垂落在肩上"
    },
    “面部特征”：{
      "表情": "温柔、平静、略带内省、轻松的嘴角和柔和的眼神",
      "makeup": "非常淡、自然的妆容，低调的定义，没有戏剧性或沉重"
    },
    “身体详细信息”：{
      "build": "身材苗条至中等，比例自然",
      “可见纹身”：[
  ...
  “姿势”：{
    "position": "坐在床边靠近边缘，舒适休闲",
    “legs”：“膝盖弯曲并靠拢，形成紧凑、舒适的轮廓”，
    “hands”：“一只手将手机举向镜子进行自拍构图，另一只手轻轻触碰嘴唇或靠近嘴部，做出深思熟虑的姿势”，
    “orientation”：“身体朝向镜子倾斜，脸部部分被手机遮挡，保持真实的镜子自拍取景”
  },
  “服装”：{
    "outfit_type": "适合轻松卧室环境的轻质睡衣或柔软休闲衬裙",
    "color": "柔和的白色或象牙色（干净、简约、柔和的色调）",
    "material": "柔软细腻的面料，略带半透明感，同时又保持雅致而不露骨",
    "details": "细肩带带有精致的蕾丝边和精致的装饰细节"
  },
  “造型”：{
    “配件”：[
      “带有小吊坠或简单链条的简约项链”，
    ...
    "nails": "自然指甲或轻微修剪的中性指甲，不浮华",
    "overall_style": "柔软、女性化、亲密、安静的美感，但不会显得过于风格化或做作"
  },
  “照明”：{
    "type": "自然光",
    "source": "窗户光以小角度从侧面射来，轻轻地包裹着拍摄对象",
    “质量”：“漫射、柔和、均匀的照明，在皮肤和织物上平滑衰减”，
    “shadows”：“非常温和的阴影，添加自然轮廓，没有刺眼的对比，保持心情温柔和通风”
  },
  “心情”：{
    "emotional_tone": "平静、温暖、深思熟虑、安静亲密",
    "visual_feel": "平和、柔和、真实，就像在平静的早晨捕捉到的坦诚瞬间"
  },
  “相机详细信息”：{
    "camera_type": "智能手机摄像头捕捉",

"lens_equivalent": "手机自拍镜头典型的广角感觉（约 24-28 毫米等效值）",
    "perspective": "镜面自拍视角，取景真实，手持真实感轻微",
    "focus": "清晰地聚焦在拍摄对象上，具有自然的深度提示，背景柔和易读，但不会过于清晰",
    "aperture_simulation": "类似手机的浅深度印象（f/1.8 到 f/2.2 风格的外观），微妙且可信",
    "iso_simulation": "低 ISO 可获得干净的图像，噪音最小，同时保留自然纹理",
    "shutter_speed_simulation": "足够快，即使手持拍摄也能减少运动模糊并保持细节清晰",
    "white_balance": "中性日光平衡与柔和的温暖，避免过黄或过蓝的色调"
  },
  “渲染风格”：{
    "realism_level": "超真实感",
    "detail_level": "高保真皮肤纹理、逼真的织物悬垂性和蕾丝行为、自然光照渐变和逼真的阴影",
    "post_processing": "柔和的对比度与柔和的高光、自然的色彩分级、温和的清晰度，保留皮肤纹理而不使其平滑",
...
Create a detailed indoor lifestyle portrait with a mirror-selfie aesthetic, capturing a serene and intimate moment in a sunlit bedroom. The scene features a young adult with a feminine presentation, styled with minimal and natural aesthetics, seated comfortably on a bed. Utilize natural daylight to achieve a soft and realistic visual feel, focusing on photorealistic rendering with high fidelity texture and natural lighting gradients.
