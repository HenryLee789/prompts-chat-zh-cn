...
    "year": "维京时代（约 9-10 世纪）",
    “类型”：“历史史诗/坚韧现实主义/冒险”，
    "location": "雕刻龙首长船的木制船头，穿过漆黑波涛汹涌的水面。峡湾两岸陡峭、雾气缭绕的山脉拔地而起。山峰上可能可见积雪。天空阴沉沉的。",
    "lighting": "寒冷、弥漫的北方日光。天气阴沉且阴沉，产生柔和但明显的阴影。光线强调湿木头、金属和毛皮的纹理。没有温暖的阳光。",
    "camera_angle": "中远景，略低角度，仰视拍摄对象，在巨大峡湾的背景下强调他们的力量和领导力。（1:1构图）。",
    "emotion": "激烈、威严、坚定、粗犷。",
    "costume": "厚重、正宗的维京服装：厚厚的熊毛或狼毛斗篷，用华丽的胸针扣在用铁板或链甲加固的皮甲上。一把巨大的、经过战斗磨损的长胡子斧头放在肩膀上或紧紧地握着。头发可能会编成辫子，如果适用的话，还有粗糙的胡须。可见皮肤上有微妙的、历史上合理的纹身。",
    "color_palette": "以冷、自然的色调为主：深海蓝色和灰色、湿木材和皮革的深棕色、岩石和天空的板岩灰色以及毛皮的自然色调。金属装饰是暗铁，而不是闪亮的钢。",
    "atmosphere": "史诗般、原始、寒冷和冒险。空气中弥漫着海浪的冰冷和潮湿。海浪拍打木头的声音几乎听得见。一种长途旅行和征服的感觉。",
    "subject_expression": "凶猛而坚定的目光注视着前方的地平线。脸部呈冷酷的指挥线，显示出抵御恶劣天气的能力。海浪可能会溅到他们的脸上。",
    "subject_action": "以宽阔、稳定的姿势站在移动的甲板上。一只手握住船的龙头或索具，另一只手握住斧头。他们正在对抗大海的运动。",
