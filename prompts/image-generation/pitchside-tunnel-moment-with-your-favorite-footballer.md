# 与你最喜欢的足球运动员一起在球场边的隧道时刻

## 中文说明

上传你的照片，输入足球运动员的名字，然后为他们所持有的球衣选择一支球队。该场景是在挤满足球运动员支持者的看台前生成的，而持有的球衣与你所选球队的官方颜色和设计保持一致。
...
* 描述主体、构图、光线、风格和画质要求
* 把创意概念转化为稳定的视觉生成指令
* 围绕 Nano Banana、Art、Creative Writing 等主题生成结构化结果
...
球衣号码：${Jersey Number}
球衣球队名称：${Jersey Team Name}（所持有球衣的球队）
用户服装：${User Outfit Description}
心情： ${Mood}

提示
根据用户上传的照片创建一个人站在体育场看台前 ${Footballer Name} 球场边摆姿势拍照的逼真图像。地点：大型体育场的球场边/边线。天然草坪和广告牌看起来很逼真。看台：背景看台必须感觉100%像${Footballer Name}的球队主场人群（单队氛围）。球队的主导颜色、围巾、旗帜和横幅。没有可见的对手球队颜色或混合部分。构图：两个主题都集中，并肩。 ${Footballer Name} 可以用一只手臂环绕用户。道具：他们一起拿着一件球衣对着镜头。球衣背面必须清楚地显示${Footballer Name}和号码${Jersey Number}。打印对齐清晰、锐利且真实。关键规则（将持有的球衣锁定特定球队）

他们所持有的球衣一定是${Jersey Team Name}的官方球衣设计。球衣颜色、图案、整体设计与${Jersey Team Name}保持一致。如果套件通常包含徽章和赞助商，请将它们自然且真实地放置（不要扭曲的徽标或随机文本）。防止颜色漂移：球衣的主色和副色必须与 ${Jersey Team Name} 的已知颜色保持一致。注意：${Jersey Team Name} 不得是 ${Footballer Name} 目前效力的俱乐部。服装：

${Footballer Name}：穿着现在球队的比赛服（球衣、短裤、袜子），看起来自然而准确。用户：${User Outfit Description}

相机：视平线，35mm，微广角，自然景深。焦点集中在两个人身上，背景略显模糊。照明：体育场照明+日光（或晚间比赛灯）、逼真的阴影、自然的肤色。面孔：保持用户的面孔和身份与上传的参考一致。 ${Footballer Name} 清晰可辨。表达式：${Mood}

质量：超逼真，自然的皮肤纹理和织物纹理，高分辨率。负面提示
所持有的球衣上的球队颜色bug、随机或损坏的徽标/文本、不可读的姓名/号码、多余的肢体/手指、面部扭曲、水印、严重模糊、重复的人群面孔、过度锐化。输出
单幅图像，3:2 横向或 1:1 方形，高分辨率。
```
