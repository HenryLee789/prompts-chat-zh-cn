...
一个激动人心的电影时刻，捕捉到了一位传奇太空海盗和他的军需官在一次大胆的逃跑过程中指挥一艘星际飞船穿过碎片场的故事。
...
```md
{
  ...
  “详细信息”：{
    "year": "2492，后人类时代",
    "genre": "电影照片写实主义",
    "location": "‘铁隼’号星舰饱经战痕的指挥桥，巨大的防爆窗俯瞰着不稳定的红色星云。”,
    “照明”：[
      “动态紧急红色频闪灯”，
      “全息界面发出凉爽的青色光芒”，
      “来自外部星云的柔和边缘照明”
    ],
    "camera_angle": "1:1 取景的中景镜头，重点关注两个主体之间的相互作用和混乱的背景。",
    “情感”：[
      “高度集中”，
      “肾上腺素飙升”，
      “确定”
    ...
    "environmental_elements": "火花从损坏的头顶导管中喷涌而出，漂浮的尘埃被光束捕获，前景中复杂的 3D 全息星图。",
    “主题1”：{
      "costume": "仿旧厚重皮革风衣，带有磁性装甲镀层和未来科技弹带。",
      "subject_expression": "凶猛、威严的怒容，在警报声中大喊命令。",
      "subject_action": "以令人紧张的强度握住船舶的手动控制杆。"
    },
    “否定提示”：{
      “排除视觉效果”：[
        “明亮的白天”，
    ...
    “主题2”：{
      "costume": "合身的战术飞行服，配有发光数据接口手套和耳机。",
      "subject_expression": "敏锐、精于算计、不受混乱影响。",
      "subject_action": "快速操纵逃生路线的浮动全息投影。"
    }
  }
}
```
...
A high-octane cinematic moment capturing a legendary space pirate and his quartermaster commanding a starship through a debris field during a daring escape.
