...
超真实、原始、坦率的 iPhone 风格屋顶泳池肖像，充满主导、自信的能量和编辑润色，看起来不像舞台或工作室灯光。
...
```md
{
  "pack_name": "BOLD - 屋顶地狱/黄金时刻",
  "intent": "生成一幅超真实、原始、坦率的 iPhone 风格的屋顶泳池肖像，具有主导、自信的能量和编辑润色，而不是舞台灯光或工作室灯光。",
  “内容安全”：{
    "age_requirement": "所有受试者必须是 21 岁以上的成年人。",
    "nudity_level": "不露骨。仅限泳装。没有可见的乳头、乳晕或生殖器。没有纯粹的透明度来揭示明确的解剖结构。",
    "tone": "自信向前，不是色情。社论中的渴陷阱能量是允许的，但要保持雅致且不露骨。",
    “no_minor_look”：正确
  },
  “全局风格质量”：{
    "photography_style": "RAW 偷拍 iPhone 摄影",
    “realism”：“超现实，纹理前向，毛孔和自然皮肤细节可见”，
    "resolution_hint": "8K 外观（高细节、清晰纹理、非人工锐化）",
    “grading”：“自然但强烈阳光下的高对比度，最小化风格化，避免电影般的青橙色外观”，
    "retouching": "无重修图，无塑皮，保持微观质感",
    "vibe": "影响者和编辑的混合体，优质但未经过滤",
    “整体情绪关键词”：[
      “大胆”，
      “主导”，
      “无忧无虑”,
  ...
  “场景设置”：{
    ...
    “人群控制”：{
      "crowd_level": "最小",
      "extras_behavior": "如果出现任何额外的东西，它们必须是遥远的、模糊的且不会分散注意力。这个场景读起来就像奢华的沉默。"
    }
  },
  “主题”：{
    "type": "单一主要科目",
    ...
    “身体特征”：{
      "waist": "纤细腰部，核心激活可见",
      "upper_body": "肩膀和手臂轮廓分明，姿势有力",
      "legs": "姿势强调长腿线条",
      "pose_energy": "身体占据空间，扎根主导地位"
    },
    “脸”：{
      "eyes": "大而自信的眼睛，直视或半闭眼的目光",
      "express": "冷静、占主导地位、不受干扰、没有表演性的微笑",
      "freckles": "强光下可见的浅雀斑",
      "lips": "自然饱满的嘴唇，轻松但自信",
      “情感关键字”：[
        “冷静的统治”，
    ...
    “皮肤”：{
      "undertone": "浅色中性底色",
      "finish": "SPF 加上天然油光泽",
      "texture": "可见的毛孔和真实的微观纹理",
      "highlights": "肩膀和锁骨上的阳光亲吻的亮点",
      “避免”：[
        “脸部过于光滑”，
        “瓷肌”，
        “美颜滤镜模糊”
    ...
    “头发”：{
      “颜色”：“深棕色”，
      "style": "从炎热中恢复光滑，外观略显湿润",
      "mess_level": "受控混乱",
      “detail”：“几根松散的发丝捕捉着金色的光芒”
    },
    “纹身”：{
...
“完整性规则”：[
  ...
  “衣柜”：{
    ...
    “顶部”：{
      "type": "小三角顶",
      "fit": "紧绳，最少的面料",
      “notes”：“保持遮盖雅致且不露骨；不要露出乳头或乳晕。”
    },
    “底部”：{
      "type": "高帮下装",
      "style": "80 年代提臀",
      “notes”：“保持有品味的取景；避免露骨的曝光。”
    },
    "styling_priority": "最少的面料，最大的表达，对性的信心"
  },
  “场景设置”：{
    "position": "站在泳池边",
    “立场”：[
  ...
  “相机捕获”：{
    "camera_type": "智能手机",
    "phone_reference": "iPhone风格的拍摄，广角镜头的感觉",
    "lens_equivalent_mm": "24-28mm 等效值（手机宽）",
    “首选感觉”：[
      “手持式”，
      “轻微的微晃动真实感”，
      “温和的柔软度，而不是极端的锐度”，
    ...
    “角度”：{
      "primary": "权力优势的低角度",
      "tilt": "轻微的荷兰式倾斜，微妙但不极端",
      "distance": "足够近，可以感觉到存在，而不是局促"
    },
    “框架”：{
      "primary_crop": "大腿中部到头部（主要肖像取景）",
      "alternate_crop": "腰部以上的英雄裁剪（纹身完全可见）",
      “作文注释”：[
        “天空下的强烈剪影”，
        “天际线可见但次要”，
        “无限边缘线干净而优质”，
    ...
    “焦点”：{
      "subject_priority": "脸部、纹身和皮肤纹理上最清晰的细节",
      "background": "天际线稍微柔和，可读但不会分散注意力",
      "avoid": "人造散景看起来像单反相机；保持手机般的深度"
    }
  },
  “照明”：{
    "type": "刺眼的自然光，高对比度",
    "time_window": "火热色调的黄金时段",
    “太阳行为”：{
      "sun_position": "背后或侧背的低阳光以创建边缘亮点",
      "lens_flare": "故意的太阳耀斑击中镜头",
      "flare_intensity": "中等、受控、不会冲淡主体"
    },
    “皮肤亮点”：[
      “肩膀上的亮点”，
      “锁骨发光”，
    ...
    "shadow_character": "清脆但不压碎；在阴影中保持纹理",
    “避免”：[
      “演播室灯光”，
      “柔光箱反射”，
      《平面美容照明》
...
“输出格式”：[
    {
      "use_case": "Instagram feed 社论",
      “纵横比”：“4：5”，
      "resolution_hint": "2160x2700 或更高",
      “framing”：“大腿中部到头部，天际线在上部背景中可见，纹身居中”
    },
    {
      "use_case": "故事/卷轴缩略图",
      “纵横比”：“9:16”，
      "resolution_hint": "2160x3840 或更高",
      “取景”：“腰部英雄剪裁，纹身完全可见，镜头光晕线更强”
    },
    {
      "use_case": "方形轮廓柱",
      “纵横比”：“1：1”，
      "resolution_hint": "2048x2048 或更高",
      “取景”：“腰部紧绷，目光集中，城市的散景降至最低”
    }
  ],
  “变体”：[
    {
      "variant_name": "V1 - 最大优势，耀斑控制",
      “changes_from_master”：[
        “稍微增加低角度效果”，
        “保持耀斑适度和清洁，不要清洗面部细节”，
        “使天际线稍微清晰一些，但仍然是次要的”
      ],
      "prompt_addendum": "稍强的低角度功率取景，使纹身完全清晰，控制耀斑以避免脸上出现雾气。"
    },
    {
      "variant_name": "V2 - 热雾溢价，更坦率的缺陷",
      “changes_from_master”：[
        “仅在背景中引入微妙的热雾微光”，
        “在锁骨和肩膀上添加微水滴”，
        “手持设备的缺陷稍多一些”
      ],
      "prompt_addendum": "添加微妙的背景热光、在肩膀和锁骨上捕捉阳光的微小水滴、稍微不完美的手持裁剪，就像真实的时刻一样。"
    },
    {
      "variant_name": "V3 - 城市灯光发光强调",
      “changes_from_master”：[
        “更多可见的城市灯光开始发光”，
        “稍微暗一点的天空渐变”，
        “保持拍摄对象曝光正确，避免 HDR”
      ],
      "prompt_addendum": "远处的城市灯光轻轻亮起，天空渐变微妙加深，保持拍摄对象适当的曝光和自然。"
    },
    {
      "variant_name": "V4 - 天空下的强烈剪影",
      “changes_from_master”：[
        “将太阳稍微放在拍摄对象后面以获得边缘光”，
        “增加轮廓清晰度”，
        “保持面部特征仍然可读”
      ],
      "prompt_addendum": "背光，肩膀和发际线周围有干净的边缘高光，在天空的映衬下更清晰的轮廓，同时保持眼睛和雀斑的可读性。"
    },
    {
      "variant_name": "V5 - 手机证明更强",
      “changes_from_master”：[
        “让手机在画面下角更加清晰可见”，
        “确保没有屏幕文本”，
        “保持坦诚的感觉”
      ],
      "prompt_addendum": "手机清晰可见，作为自拍证据，屏幕上没有文字，无法读取，保持自然，就像真实的捕捉一样。"
    },
    {
      "variant_name": "V6 - 纹身英雄取景",
      “changes_from_master”：[
        “框架稍高，优先考虑胸部纹身”，
        “减少天际线的突出程度”，
        “保持比基尼线真实且不缠结”
      ],
      "prompt_addendum": "优先考虑胸部纹身作为英雄细节，减少天际线优势，保持比基尼带的物理可信度和自然张力。"
    }
  ],
  “高级控制可选”：{
...
“纹身的完整性必须保持准确，没有漂移。”,
    ...
    “迭代配方”：[
      “从 4:5 的 V1 开始，验证姿势和优势角度。”,
      “切换到V6以验证纹身的易读性和未突变。”,
      “在 9 点 16 分测试 V3 的天际线发光和耀斑平衡。”,
      “如果输出看起来太电影化或修饰太多，请严格应用 negative_prompt_master。”
    ]
  },
  “创意选项”：{
    "idea": "如果你想让它感觉更‘真实的 iPhone’，只需在一个角落添加微小的镜头污迹和微眩光，但要保持微妙，这样它看起来就像是真实的，而不是滤镜。”,
    “切换”：“可选”
  }
}
```
