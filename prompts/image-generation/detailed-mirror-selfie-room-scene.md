...
* 姿势：
    ...
    * 躯干：身体稍微向后倾斜；腰部和腹部暴露
* 服装：
    * 上衣：浅蓝色短款针织开衫，顶部两颗纽扣扣紧；蓝色法式胸罩依稀可见
    * 下装：牛仔超短短裤，臀部两侧各有一个蓝色缎带蝴蝶结
    * 袜子：蓝白横条纹过膝袜
    * 配件：蓝色可爱吉祥物手机壳一个
...
* 曝光：
    ...
    * 曝光补偿（EV）：-0.3
* 聚焦：聚焦于镜像中的躯干和短裤
* 景深：自然智能手机的深景深；背景清晰可见，没有人为模糊
* 成分：
    * 纵横比：1:1
    * 裁剪：从头顶到大腿中部；包括框架中的桌子、显示器、电脑塔和植物
    *角度：从镜子的角度来看稍高的角度
    * 构图注意：保持主题居中；为了避免广角边缘变形，请让她站得远一点，然后裁剪成正方形。

### 负面提示
* 任何地方出现粉红色/洋红色
*美容滤镜/过度平滑的皮肤；无毛孔皮肤外观
* 夸张或扭曲的解剖结构
* NSFW、透明面料、衣柜故障
* 徽标、品牌名称或可读的用户界面文本
* 假人像模式模糊、CGI/插画感觉
