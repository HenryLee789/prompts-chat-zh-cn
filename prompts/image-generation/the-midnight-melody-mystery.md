...
这是一个迷人的动画黑色场景，一位粗暴的侦探在 20 世纪 50 年代风格的俱乐部里询问一位迷人的爵士歌手。
...
{
  "title": "午夜旋律之谜",
  "description": "一个迷人的动画黑色场景，一位粗鲁的侦探在 20 世纪 50 年代风格的俱乐部里询问一位迷人的爵士歌手。",
  "prompt": "你将使用所提供照片中的人物作为主要拍摄对象进行图像编辑。保留他们的核心相似性，但风格化。将拍摄对象 1（男性）和拍摄对象 2（女性）转换为高预算动画电影中的角色。拍摄对象 1 是一名愤世嫉俗的私家侦探，拍摄对象 2 是一位令人眼花缭乱的休闲歌手。他们坐在烟雾缭绕的装饰艺术爵士俱乐部的弧形天鹅绒展位上。审美必须是独特的“迪士尼角色”风格，具有平滑的阴影、富有表现力的大眼睛以及神奇的电影光芒。”,
  “详细信息”：{
    "年份": "20世纪50年代黑色时代",
    “类型”：“迪士尼角色”，
    "location": "Blue Note Lounge，一个风格化的爵士乐俱乐部，拥有装饰艺术风格的建筑、豪华的红色天鹅绒摊位和背景中的舞台。",
    “照明”：[
      “电影聚光灯”，
      “软体积雾”，
      “台灯发出温暖的金色光芒”，
    ...
    "camera_angle": "在眼睛水平的中特写，将两个拍摄对象放在一个小圆桌上。",
    “情感”：[
      《阴谋》，
      “戏谑的怀疑”，
      “魅力”
    ...
    "environmental_elements": "旋转的风格化烟雾形状，背景中的老式麦克风，桌子上有装饰的水晶玻璃。",
    “主题1”：{
      "costume": "一件经典的棕褐色翻领风衣，一顶配套的软呢帽，一条宽松的领带。",
      "subject_expression": "扬起的眉毛和傻笑，看起来怀疑但又着迷。",
      "subject_action": "拿着一个小记者笔记本和一支铅笔，身体稍微前倾在桌子上。"
    },
    “否定提示”：{
      “排除视觉效果”：[
        “照片写实主义”，
    ...
    “主题2”：{
      "costume": "一件闪闪发光的及地红色晚礼服，搭配白色长手套和珍珠项链。",
      "subject_expression": "腼腆、自信的微笑，厚重的眼睑，扮演蛇蝎美人的角色。",
      "subject_action": "优雅地将下巴搁在戴着手套的手上，直视侦探。"
    }
  }
}
...
A charming, animated noir scene where a gruff detective questions a glamorous jazz singer in a stylized 1950s club.
