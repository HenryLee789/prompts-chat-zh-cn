...
用于让 AI 围绕「母亲节」执行图像生成提示词设计任务。它会保留原始角色、任务目标、约束条件和输出要求，适合复制给图像生成模型，控制主体、构图、风格和画面细节。
...
* 描述主体、构图、光线、风格和画质要求
* 把创意概念转化为稳定的视觉生成指令
* 围绕 Nano Banana、image-generation、ChatGPT 等主题生成结构化结果
...
```md
主要提示 -
使用上传的我妈妈（或我和妈妈）的参考照片，设计一个舒适的墙壁拼贴画。将参考照片作为主要的中央宝丽来固定在软木板或灯串上，保持我们的脸部和表情完全相同。用几个较小的宝丽来风格相框包围它，展示AI想象的柔和回忆：生日、节日、安静的下午茶时间、家人的拥抱。在中央照片下方添加手写文字：“妈妈，母亲节快乐”。风格：温暖的室内光线、柔和的阴影、柔和的色彩、略带纹理的纸张外观。图片 2 -
使用上传的妈妈和孩子的参考照片，将他们转变为受皮克斯启发的风格化 3D 角色，同时保留参考中他们可识别的面孔、发型和整体比例。保持他们的姿势和亲密程度不变，但把他们放在一个舒适的客厅里，客厅里装饰有气球、鲜花，背景是“母亲节快乐”的小横幅。风格：鲜艳的色彩、柔和的 3D 灯光、富有表现力的大眼睛、高细节的皮克斯渲染、垂直 4:5 比例。图片 3 -
使用上传的我妈妈的参考肖像照片，创建一个垂直的 9:16 母亲节社交媒体图像。准确地保留她的面部特征和表情。将她放置在稍微偏离中心的位置，使用柔和模糊的柔和背景和微妙的花卉光环围绕着她。在顶部添加优雅的文字，上面写着“母亲节快乐”，在底部添加一条小行“谢谢你所做的一切”。风格：柔和的工作室光线、光滑的皮肤但自然的纹理、现代的 Instagram 设计、高分辨率。秘密报纸提示——
使用上传的母子照片创建一个异想天开的黑白复古印地语报纸头版。将它们转变成雕刻的古董报纸肖像，同时保留其真实的面部特征和情感温暖。将页面设计得像一本厚重的古老奇幻社论报纸，致力于母性和母子之间的联系。使用经典的印地语衬线字体、狭窄的报纸栏、微妙的纸张纹理、白纸上的高对比度黑色墨水、古怪的编辑布局、情感化的故事片段、俏皮的假广告、复古邮票和神奇的复古报纸美学。报纸必须自动包含：

母亲姓名：[MOTHER_NAME]
孩子的姓名：[CHILD_NAME]

添加创意印地语母亲节标题、情感俏皮话、幽默旁注以及一篇简短的特色“新闻文章”，介绍[CHILD_NAME]如何将[MOTHER_NAME]视为他们的超级英雄、最安全的地方和最大的爱的源泉。保持肖像居中并占据主导地位，而报纸的其余部分则给人怀旧、情感、略带超现实、幽默和美丽混乱的感觉，就像一份古老的、具有收藏价值的印地语报纸一样。女王形象——
使用上传的照片作为准确的参考。不要改变面孔、发型、衣服、姿势、表情或身体结构。创作一幅温馨的电影般的母亲节肖像，其中女儿轻轻地将金色王冠戴在母亲头上，而她则优雅地坐在优雅的椅子上。舒适的室内环境，配有柔和的金色灯光、鲜花、蜡烛和散景背景。超现实、情感、奢华的摄影风格、INSTAGRAM 美学。添加优雅的文字：“母亲节快乐”和“感谢你成为我的第一个家”。4:5 比例。
```
