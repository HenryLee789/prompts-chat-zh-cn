...
这张照片捕捉了一位年轻女性的侧面镜子自拍照，突出显示了她浓密的黑发卷发和左侧柔和的自然光照亮的健美体格。她穿着一件合身的米色长袖亨利短上衣，强调了她的腰部，搭配低腰灰色下装，打造出休闲而自信的外观。
...
```md
{
  “图像分析”：{
    “环境”：{
      ...
      "spatial_depth": "由于镜面反射导致景深较浅",
      "background_elements": "灰色墙壁，左侧白色门框或窗框边缘，右侧电源插座，白色水槽的部分视图"
    },
    “相机规格”：{
      "lens_type": "智能手机广角镜头（反射）",
      "angle": "眼睛水平，相对于镜子笔直",
      "perspective": "自拍倒影",
      “focus”：“对主体进行清晰聚焦，对背景反射进行轻微柔和”
    },
    “照明”：{
      “条件”：“自然日光与室内环境光混合”，
      “来源”：[
        {
          ...
          “强度”：“中到高”，
          "effect_on_subject": "突出罗纹上衣的纹理，照亮面部轮廓和躯干，在中腹部创建柔和的渐变"
        }
      ],
      "shadows": "柔和的阴影投射在主体身体的右侧（远离窗户）和胸围线下方"
    },
    “主题分析”：{
      "identity": "年轻女子（脸部被头发和角度部分遮挡）",
      "orientation": "身体向左倾斜 45 度，头部转向左侧的侧面视图",
      "emotional_state": "冷静、专注、随意的自信",
      "visual_appeal": "美观、合身、自然",
      “姿势”：{
        "general_definition": "直立，臀部轻微摆动",
        "feet_placement": "在框架中不可见",
        "hand_placement": "左手握住手机（可见），右臂放在一边（部分可见）",
        "visible_extent": "从头顶到臀部/大腿上部"
      },
      “头详细信息”：{
        “头发”：{
          “颜色”：“深棕色/浓咖啡”，
          "style": "齐肩、分层剪裁",
          "texture": "卷曲/波浪形、体积庞大、凌乱别致",
          "interaction_with_face": "线从前额垂下，框住颧骨，部分遮挡眼睛"
        },
        "ears": "被头发覆盖",
        “脸”：{
          "definition": "侧面轮廓视图",
      ...
      “身体详细信息”：{
        "body_type": "Ectomorph-Mesomorph 混合（具有定义曲线的苗条）",
        "skin_tone": "浅橄榄色/白皙",
        "neck": "修长，锁骨微微可见",
        "shoulders": "窄，放松",
        “胸部区域”：{
          "ratio_to_body": "与苗条身材成比例",
          "visual_estimate": "中等胸围",
          "undergarment_indicates": "没有可见明显的肩带线；可能是无缝的或没有胸罩",
          "nipple_visibility": "由于织物厚度而未明确定义",
          "shape_in_clothing": "紧密面料支撑的自然泪滴形状"
        },
        “中段”：{
          "belly_button": "可见，垂直方向",

"ratio": "细腰，腹肌清晰（白线可见）",
          "relation_to_chest": "明显变窄（沙漏建议）",
          "relation_to_hips": "向内逐渐变细，然后向臀部张开"
        },
        “臀部区域”：{
          "ratio_to_waist": "比腰宽",
          "visibility": "顶部曲线可见",
      ...
      “服装”：{
        “上身”：{
          "item": "长袖短款上衣",
          "style": "亨利领，带纽扣（3 个可见，顶部未扣），罗纹针织纹理",
          “颜色”：“浅棕色/灰褐色/摩卡色”，
          "fit": "合身/紧身",
          "fabric_drape": "伸展胸部，拥抱腰部，袖口位于手腕处"
        },
        “下体”：{
          "item": "裤子/打底裤（仅腰带）",
          “颜色”：“希瑟灰色”，
    ...
    “场景中的对象”：[
      {
        “对象”：“智能手机”，
        "description": "黑色外壳，多个摄像头（iPhone Pro 型号风格）",
        "function": "捕获设备",
        "position": "左手握住，图像右侧",
        “颜色”：“黑色”
      },
      {
        “对象”：“镜子”，
        "description": "包含整个主体的反射表面",
        "function": "自拍媒介",
        "position": "前景平面"
      },
      {
        "object": "电源插座",
        "description": "标准白色墙壁插座",
        "position": "背景，主体后面的右侧",
        “颜色”：“白色”
      },
      {
...
This image captures a side-profile mirror selfie of a young woman, highlighting her voluminous curly brunette hair and a fit physique illuminated by soft natural light from the left. She wears a form-fitting, long-sleeved beige henley crop top that emphasizes her waist, paired with low-rise grey bottoms for a casual yet confident look.
