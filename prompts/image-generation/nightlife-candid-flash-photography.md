...
通过高角度、刺眼的直接闪光照片捕捉真实的夜生活瞬间。这个场景的主角是一位年轻女子在昏暗的户外酒吧里，散发着原始、坚韧的千年氛围。提示将引导你创建具有长焦压缩、自然面部比例和逼真纹理的真实快照。非常适合以最小的风格化生成高真实感图像，重点关注街头服饰夜生活能量。
...
```md
夜间在黑暗的户外酒吧庭院中拍摄的高角度、刺眼的直接闪光快照，从稍上方拍摄，就好像相机举在头顶上或从小台阶或阳台上拍摄一样。图像采用长焦压缩构图，以避免广角失真和通用AI智能手机的外观。在人像范围内使用长镜头（相当于 85 毫米到 200 毫米），摄影师站在比典型自拍距离更靠后的位置，使拍摄对象的面部比例看起来自然且高端。场景：夜间，一名年轻成年女性（21 岁以上）随意坐在昏暗的户外酒吧区的吧台凳上。除了闪光灯衰减之外，环境大部分都是黑暗的。直射闪光很刺眼，而且接近同轴，在她白皙的皮肤上产生明亮的过度曝光，清晰的镜面高光，以及在她身后投射到地面上的锐利、硬边的阴影。阴影形状清晰且对比度高，环境填充最少。背景基本上不清晰，人们的微弱轮廓坐在闪光灯照射不到的外围，由于长焦压缩，背景变得稍大并“堆叠”在她身后更近，但仍然昏暗且不会分散注意力。对象详情：她有一种顽皮、顽皮的表情：一只眼睛眨着，伸出舌头，以一种戏弄、坦率的方式。她的灰棕色短波波头是中分的，松散的发丝向前垂下，部分遮住了她的脸。在刺眼的闪光灯下，她的浅棕色眼睛清晰可见，睫毛卷曲。她的嘴唇有光泽，粉红色，由于伸出舌头的表情而微微张开。她有一个隔膜穿孔，可以用一个小的金属亮点捕捉闪光。她的皮肤呈现出自然的纹理和毛孔，带有自然的腮红，虽然被闪光灯吹掉了一部分，但仍然可信。没有美容滤镜平滑，没有塑料皮肤。衣柜：她穿着一件黑色背心，里面穿一件蓝色、白色和黑色的开放式格子法兰绒衬衫，布料褶皱逼真，有轻微磨损的感觉。她有一条牛仔迷你裙和一条小黑腰带。这套服装看起来像是原始的 Y2K 垃圾街头服饰，是坦率的夜生活活力，而不是舞台时尚。她的手臂和手上有明显的纹身，线条清晰，保持一致且不变形。手和香烟：她的左手放松，姿势自然，手指间夹着一根点燃的香烟。香烟余烬清晰可见，烟羽捕捉到闪光，形成一条明亮、有纹理的烟带，在黑暗背景下具有锐利的高光边缘。烟雾看起来很真实，而不是一层雾气，带有不均匀的缕缕和微妙的湍流。前景桌：她面前是一张饱经风霜的圆形石桌，上面有逼真的污渍和表面纹理。桌子上有多个装满饮料的玻璃杯（形状和填充量混合）、一个玻璃水罐和一包香烟，标签为“{argument name="香烟品牌" default="Gudang Garam Surya 16"}”。该包清晰地出现在桌子上，随意倾斜，就像真正的夜间外出快照一样。玻璃上的反射由闪光驱动且坚硬，具有明亮的热点和快速衰减。构图和感觉：摄像角度从上往下看，但不是超广角。构图有点不完美和自发，就像夜生活时刻的真实闪光照片。保持主体在画面中占主导地位，同时允许桌面对象锚定前景。背景顾客几乎看不见，黑暗且失焦。整体审美：原始、坚韧、坦率、千年垃圾、街头夜生活、纪实快照。高真实感、纹理前卫、最小化风格化。光学和捕捉线索（必须遵循）：长焦镜头外观（相当于 85 毫米到 200 毫米）、压缩视角、自然的面部比例、真实的景深、光学器件的真实散景（不是假模糊）。直接闪光、硬阴影、皮肤上的高光稍微吹散，但保留了真实的纹理。允许轻微的运动真实性，但要保持面部清晰易读且不模糊。
