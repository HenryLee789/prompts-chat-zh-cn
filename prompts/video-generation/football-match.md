---
id: "cmp2jifw00001l504hlsknn6x"
slug: "football-match"
source: "https://github.com/f/prompts.chat"
source_url: "https://prompts.chat/prompts/football-match"
...
source_hash: "17696f3ca66c64e8ad1f681c0d56d919e92c94bb3610c60f061ad54b2f49969a"
upstream_updated_at: "2026-05-12T11:21:18.893Z"
---
# 足球比赛

> 来源：[prompts.chat](https://github.com/f/prompts.chat)  
> 上游页面：[football-match](https://prompts.chat/prompts/football-match)  
...
- 适合围绕 image-generation、video-generation、Nano Banana、ChatGPT 等主题快速生成可复用结果。
...
```md
1. 图像生成 - 在一场高风险、拥挤的体育场比赛中拍摄的超现实足球直播人群镜头。这一场景的捕捉与真正的直播电视观众在紧张的比赛后期时刻的镜头完全一样，因为转播摄像机自然地在观众中发现了两位著名的球迷。
两名成年男性受试者并排坐在体育场人群中，两人都直接面向镜头，以干净的正面直播角度（不是侧角）。两个拍摄对象都具有高度一致的面部特征、精确的发型、自然的表情和逼真的皮肤纹理。
完美的环境融合至关重要：灯光、阴影、肤色、反射、曝光、对比度、色温和体育场光溢出必须与周围的人群和背景无缝融合。没有粘贴的外观，没有人为的边缘分离，没有不匹配的灯光，没有工作室照片的外观。两个主题都必须感觉完全融入了直播环境。
对象 1 穿着正品莱昂内尔·梅西 (Lionel Messi) 队球衣，清晰可见，自然地坐着，脸上挂着微妙的休闲微笑。
对象 2 就坐在他旁边，穿着正宗的克里斯蒂亚诺·罗纳尔多队球衣，也清晰可见。
两人对比赛气氛的反应都很自然，就好像现场观众摄像机随意捕捉到的一样——没有摆姿势，没有夸张，也没有一直盯着镜头。
广播记分牌覆盖在帧的顶部：
梅西队 5 — 0 罗纳尔多队 | 89:24
这清楚地表明了比赛后期占据主导地位的局面，梅西的球队只需一球就能锁定一场戏剧性的胜利。
视觉和技术品质：
...
宽高比：16:9 — 单连续前置摄像头画面，无剪辑、无电影分级、无慢动作。


2. 修复照明 - 改善照明，同时保持其他一切完全相同。请勿改变人物、姿势、表情、背景或构图。修复背光、刺眼阴影、曝光不足或照明不均匀等问题。将原始照明转换为柔和、自然、讨人喜欢的光线，光线略高于眼睛水平并面向拍摄对象，使脸部照明均匀，肤色逼真。保持结果逼真并与原始场景一致。 
...
📐 格式和拍摄规格
持续时间：5 秒 |比例：16:9 |单次连续拍摄
相机：手持广播级变焦镜头，轻微有机抖动
风格：超写实电视直播体育赛事转播画面
颜色等级：真实的体育转播——温暖的泛光色调， 
轻微的饱和度提升，真正的电视压缩伪影
...
角球水印：beIN Sports / ESPN FC 徽标（细微）
底部滚动条：实时比赛统计数据滚动
广播时间戳刻录：右下角
轻微的扫描线纹理，真实的电视压缩噪声
...
| Upstream URL | [football-match](https://prompts.chat/prompts/football-match) |
| Category | Video Generation (`video-generation`) |
| Type | `TEXT` |
| Tags | image-generation, video-generation, Nano Banana, ChatGPT |
| Contributors | ppppatel05 |
| Updated At | 2026-05-12T11:21:18.893Z |
