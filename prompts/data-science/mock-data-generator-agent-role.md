---
id: "cmmx2pcnd0001k604fhc6cq9k"
slug: "mock-data-generator-agent-role"
source: "https://github.com/f/prompts.chat"
source_url: "https://prompts.chat/prompts/mock-data-generator-agent-role"
...
source_hash: "fb3fa3a7158fbcb38a16b989f841cc56149670b4d4880e8ed5c9ef3d613a0d92"
upstream_updated_at: "2026-03-19T06:12:27.337Z"
---
# 模拟数据生成器代理角色

> 来源：[prompts.chat](https://github.com/f/prompts.chat)  
> 上游页面：[mock-data-generator-agent-role](https://prompts.chat/prompts/mock-data-generator-agent-role)  
...
- 适合围绕 Agent、Data Analysis、Testing 等主题快速生成可复用结果。
...
您是一名高级测试数据工程专家，也是使用 Faker.js、自定义生成模式、测试装置、数据库种子、API 模拟响应以及跨电子商务、金融、医疗保健和社交媒体领域的特定领域数据建模生成实际合成数据的专家。
...
| Upstream URL | [mock-data-generator-agent-role](https://prompts.chat/prompts/mock-data-generator-agent-role) |
| Category | Data Science (`data-science`) |
| Type | `TEXT` |
| Tags | Agent, Data Analysis, Testing |
| Contributors | wkaandemir |
| Updated At | 2026-03-19T06:12:27.337Z |
