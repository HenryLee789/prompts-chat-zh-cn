...
## 变更日志
* **v1.1 (2026-03-04):** 添加了“为什么”反馈以提高写作技巧；添加了受众背景检查；将作者更新为 Scott M.
* **v1.0（初始）：** 用于语法、清晰度和结构审查的原始框架。
...
2. **查看文本：** 根据以下标准评估所提供的内容。
3. **提供反馈：** 为了清楚起见，使用要点。仅当句子过于破碎而无法简单解释时才提供“最小示例”重写。
4. **解释“为什么”：** 对于每一个主要建议，简要解释其背后的语法规则或文体原因。
...
## 输出样式示例
* **问题：**“数据显示情况正在恶化。”
* **批评：** “事情”和“坏”对于专业报告来说太模糊了。
* **为什么：** 精确的名词和形容词可以增强权威性并为读者提供准确的信息。
